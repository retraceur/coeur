...
/**
 * Authenticates the user using the Retraceur auth cookie.
 *
 * @since WP 2.8.0
 *
 * @global string $auth_secure_cookie
 ...
 *
 * @since WP 3.0.0
 * @since WP 6.9.0 The results are now cached.
 *
 * @global wpdb $wpdb WP database abstraction object.
 *
 ...
 * it will prepend the Retraceur table prefix to the option name.
 *
 ...
 * @since WP 6.0.0 Moved to wp-includes/user.php.
 *
 ...
 * @since WP 5.9.0 Added the 'capability', 'capability__in', and 'capability__not_in' parameters.
 ...
 * @since WP 6.2.0 User metadata caches are now cleared.
 *
 ...
 * @since WP 4.7.0 The `locale` field can be passed to `$userdata`.
...
function wp_insert_user( $userdata ) {
	...
	if ( ! empty( $userdata['ID'] ) ) {
		...
		if ( empty( $userdata['user_pass'] ) ) {
			wp_trigger_error(
				__FUNCTION__,
				__( 'The user_pass field is required when creating a new contributor. The contributor will need to reset their password before logging in.' ),
				E_USER_WARNING
			);
 ...
 *
 * Default contact methods were removed for new installations in WP 3.6
 * and completely removed from the codebase in WP 6.9.
 *
 * Use the {@see 'user_contactmethods'} filter to add or remove contact methods.
 *
 * @since WP 3.7.0
 * @since WP 6.9.0 Removed references to `aim`, `jabber`, and `yim` contact methods.
 *
...
function get_password_reset_key( $user ) {
	 ...
	 *
	 * @since WP 1.5.0
	 * @deprecated WP 1.5.1 Misspelled. Use {@see 'retrieve_password'} hook instead.
	 *
 ...
 * @since WP 7.0.3 Added the `$user_id` parameter, which is sent with the `personal_options_update` action.
 *
 ...
 *
 * @since WP 4.9.6
 * @since WP 5.4.0 Added 'Community Events Location' group to the export data.
 * @since WP 5.4.0 Added 'Session Tokens' group to the export data.
 *
...
function _wp_privacy_send_erasure_fulfillment_notification( $request_id ) {
	 ...
	 *
	 * @since WP 4.9.8
	 * @deprecated WP 5.8.0 Use {@see 'user_erasure_fulfillment_email_subject'} instead.
	 *
	 * @param string $subject    The email subject.
	 * @param string $sitename   The name of the site.
	 * @param array  $email_data {
...
###SITEURL###'
	 ...
	 *
	 * @since WP 5.4.0
	 * @deprecated WP 5.8.0 Use {@see 'user_erasure_fulfillment_email_headers'} instead.
	 *
	 * @param string|array $headers    The email headers.
	 * @param string       $subject    The email subject.
	 * @param string       $content    The email content.
 ...
 *
 * @since WP 4.9.6
 * @since WP 5.7.0 Added the `$status` parameter.
 *
