...
(wp ||= {}).dataviews = (() => {
    ...
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
      ...
      if (true) {
        (function() {
          ...
          var useState27 = React4.useState, useEffect18 = React4.useEffect, useLayoutEffect2 = React4.useLayoutEffect, useDebugValue = React4.useDebugValue;
  ...
  // packages/dataviews/build-module/index.js
  var index_exports = {};
  __export(index_exports, {
    DataForm: () => DataForm,
    DataViews: () => dataviews_default,
    DataViewsPicker: () => dataviews_picker_default,
    VIEW_LAYOUTS: () => VIEW_LAYOUTS,
    filterSortAndPaginate: () => filterSortAndPaginate,
    useFormValidity: () => use_form_validity_default
  });
  ...
  function ItemActions({
    ...
    const { primaryActions, eligibleActions } = (0, import_element2.useMemo)(() => {
  ...
  function CompactItemActions({
    ...
    const [activeModalAction, setActiveModalAction] = (0, import_element2.useState)(
      null
    );
  ...
  function PrimaryActions({
    ...
    const [activeModalAction, setActiveModalAction] = (0, import_element2.useState)(null);
  ...
  function ActionWithModal({
    ...
    const [isModalOpen, setIsModalOpen] = (0, import_element3.useState)(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(ActionTriggerComponent, { ...actionTriggerProps }),
      isModalOpen && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
        ActionModal,
        {
          action,
          items,
  ...
  function BulkSelectionCheckbox({
    ...
    const selectableItems = (0, import_element3.useMemo)(() => {
  ...
  function ActionButton({
    ...
    const selectedEligibleItems = (0, import_element3.useMemo)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
      import_components3.__experimentalHStack,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "dataviews-bulk-actions-footer__item-count", children: message2 }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
            import_components3.__experimentalHStack,
            {
              ...
              children: [
                ...
                selectedItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                  import_components3.Button,
                  {
  ...
  function FooterContent({
    ...
    const [actionInProgress, setActionInProgress] = (0, import_element3.useState)(
      null
    );
    const footerContentRef = (0, import_element3.useRef)(null);
    const isMobile = (0, import_compose2.useViewportMatch)("medium", "<");
    const bulkActions = (0, import_element3.useMemo)(
    ...
    const selectedItems = (0, import_element3.useMemo)(() => {
      return data.filter(
        (item) => selection.includes(getItemId(item)) && selectableItems.includes(item)
      );
    }, [selection, data, getItemId, selectableItems]);
    const actionsToShow = (0, import_element3.useMemo)(
  ...
  function BulkActionsFooter() {
    const {
      ...
      onChangeSelection,
      getItemId
    } = (0, import_element3.useContext)(dataviews_context_default);
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      FooterContent,
      {
        selection,
  ...
  function WithMenuSeparators({ children }) {
    return import_element4.Children.toArray(children).filter(Boolean).map((child, i2) => /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_element4.Fragment, { children: [
      i2 > 0 && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Menu2.Separator, {}),
      child
    ] }, i2));
  }
  var _HeaderMenu = (0, import_element4.forwardRef)(function HeaderMenu({
    fieldId,
    view,
    fields,
    onChangeView,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Menu2.Popover, { style: { minWidth: "240px" }, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(WithMenuSeparators, { children: [
        ...
        canAddFilter && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Menu2.Group, { children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
          Menu2.Item,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Menu2.ItemLabel, { children: (0, import_i18n5.__)("Add filter") })
          }
        ) }),
        (canMove || isHidable) && field && /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(Menu2.Group, { children: [
          canMove && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            Menu2.Item,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Menu2.ItemLabel, { children: (0, import_i18n5.__)("Move left") })
            }
          ),
          canMove && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            Menu2.Item,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Menu2.ItemLabel, { children: (0, import_i18n5.__)("Move right") })
            }
          ),
          isHidable && field && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            Menu2.Item,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Menu2.ItemLabel, { children: (0, import_i18n5.__)("Hide column") })
            }
          )
        ] })
      ] }) })
  ...
  function ItemClickWrapper({
    ...
    if (renderItemLink) {
      ...
      return (0, import_element5.cloneElement)(renderedElement, {
        onClick: (event) => {
          event.stopPropagation();
  ...
  function useIsHorizontalScrollEnd({
    ...
    const [isHorizontalScrollEnd, setIsHorizontalScrollEnd] = (0, import_element6.useState)(false);
    const handleIsHorizontalScrollEnd = (0, import_compose3.useDebounce)(
      (0, import_element6.useCallback)(() => {
  ...
  function TableRow({
    ...
    const { paginationInfo } = (0, import_element7.useContext)(dataviews_context_default);
    ...
    const isTouchDeviceRef = (0, import_element7.useRef)(false);
  ...
  function ViewTable({
    ...
    const { containerRef } = (0, import_element7.useContext)(dataviews_context_default);
    const headerMenuRefs = (0, import_element7.useRef)(/* @__PURE__ */ new Map());
    const headerMenuToFocusRef = (0, import_element7.useRef)();
    const [nextHeaderMenuToFocus, setNextHeaderMenuToFocus] = (0, import_element7.useState)();
    ...
    const tableNoticeId = (0, import_element7.useId)();
  ...
  var GridItems = (0, import_element8.forwardRef)(({ className, previewSize, ...props }, ref) => {
  ...
  function ViewGrid({
    ...
    const { resizeObserverRef } = (0, import_element9.useContext)(dataviews_context_default);
  ...
  function PrimaryActionGridCell({
    ...
    const [isModalOpen, setIsModalOpen] = (0, import_element10.useState)(false);
  ...
  function ListItem({
    ...
    const itemRef = (0, import_element10.useRef)(null);
    const labelId = `${idPrefix}-label`;
    const descriptionId = `${idPrefix}-description`;
    const registry = (0, import_data3.useRegistry)();
    const [isHovered, setIsHovered] = (0, import_element10.useState)(false);
    const [activeModalAction, setActiveModalAction] = (0, import_element10.useState)(
      null
    );
    ...
    const { primaryAction, eligibleActions } = (0, import_element10.useMemo)(() => {
      const _eligibleActions = actions.filter(
        (action) => !action.isEligible || action.isEligible(item)
      );
      const _primaryActions = _eligibleActions.filter(
  ...
  function ViewList(props) {
    ...
    const generateCompositeItemIdPrefix = (0, import_element10.useCallback)(
      (item) => `${baseId}-${getItemId(item)}`,
      [baseId, getItemId]
    );
    const isActiveCompositeItem = (0, import_element10.useCallback)(
      (item, idToCheck) => {
    ...
    const [activeCompositeId, setActiveCompositeId] = (0, import_element10.useState)(void 0);
    (0, import_element10.useEffect)(() => {
      if (selectedItem) {
    ...
    const selectCompositeItem = (0, import_element10.useCallback)(
    ...
    const onDropdownTriggerKeyDown = (0, import_element10.useCallback)(
      (event) => {
  ...
  function DataViewsPagination() {
    ...
    } = (0, import_element11.useContext)(dataviews_context_default);
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
            import_components9.__experimentalHStack,
            {
              ...
              children: (0, import_element11.createInterpolateElement)(
  ...
  var dataviews_pagination_default = (0, import_element11.memo)(DataViewsPagination);
  ...
  function DataViewsPickerFooter() {
    ...
    const message2 = selectionCount > 0 ? (0, import_i18n12.sprintf)(
      /* translators: %d: number of items. */
      (0, import_i18n12._n)(
        "%d Item selected",
        "%d Items selected",
      ...
      /* translators: %d: number of items. */
      (0, import_i18n12._n)("%d Item", "%d Items", data.length),
      data.length
    );
  ...
  function ViewPickerGrid({
    ...
    const { resizeObserverRef, paginationInfo, itemListLabel } = (0, import_element13.useContext)(dataviews_context_default);
    const titleField = fields.find(
      (field) => field.id === view?.titleField
    );
    const mediaField = fields.find(
  ...
  function createStoreContext(providers = [], scopedProviders = []) {
    ...
    const useContext29 = () => React2.useContext(context);
...
`
  ...
  function useElements({
    ...
    const [records, setRecords] = (0, import_element16.useState)(staticElements);
    const [isLoading, setIsLoading] = (0, import_element16.useState)(false);
  ...
  function ListBox({ view, filter, onChangeView }) {
    ...
    const [activeCompositeId, setActiveCompositeId] = (0, import_element17.useState)(
  ...
  function ComboboxList3({ view, filter, onChangeView }) {
    const [searchValue, setSearchValue] = (0, import_element17.useState)("");
    const deferredSearchValue = (0, import_element17.useDeferredValue)(searchValue);
    const currentFilter = view.filters?.find(
      (_filter) => _filter.field === filter.field
    );
    const currentValue = getCurrentValue(filter, currentFilter);
    const matches = (0, import_element17.useMemo)(() => {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)("div", { className: "dataviews-filters__search-widget-filter-combobox__wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
              ComboboxLabel,
              {
                render: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_components14.VisuallyHidden, { children: (0, import_i18n17.__)("Search items") }),
  ...
  function InputWidget({
    ...
    const currentValue = getCurrentValue(filter, currentFilter);
    const field = (0, import_element18.useMemo)(() => {
    ...
    const data = (0, import_element18.useMemo)(() => {
  ...
  function Filter({
    ...
    const toggleRef = (0, import_element19.useRef)(null);
  ...
  var add_filter_default = (0, import_element20.forwardRef)(AddFilter);
  ...
  function Filters({ className }) {
    const { fields, view, onChangeView, openedFilter, setOpenedFilter } = (0, import_element22.useContext)(dataviews_context_default);
    const addFilterRef = (0, import_element22.useRef)(null);
  ...
  var filters_default = (0, import_element22.memo)(Filters);
  ...
  function FiltersToggle() {
    ...
    const buttonRef = (0, import_element23.useRef)(null);
    const onChangeViewWithFilterVisibility = (0, import_element23.useCallback)(
      (_view) => {
        onChangeView(_view);
  ...
  function FiltersToggled(props) {
    const { isShowingFilter } = (0, import_element24.useContext)(dataviews_context_default);
    if (!isShowingFilter) {
      return null;
    }
  ...
  function PreviewOptions({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(Menu5, { onOpenChange: onMenuOpenChange, children: [
      /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
        Menu5.TriggerButton,
        {
          render: /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(Menu5.Popover, { children: previewOptions?.map(({ id, label }) => {
        return /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
          Menu5.RadioItem,
          {
            value: id,
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(Menu5.ItemLabel, { children: label })
          },
          id
        );
      }) })
  ...
  function FieldItem({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components24.__experimentalItem, { children: /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(
      import_components24.__experimentalHStack,
      {
        ...
        justify: "flex-start",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime61.jsx)("span", { className: "dataviews-field-control__icon", children: !canMove && !field.enableHiding && /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components24.Icon, { icon: lock_default }) }),
          /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)("span", { className: "dataviews-field-control__label-sub-label-container", children: [
            /* @__PURE__ */ (0, import_jsx_runtime61.jsx)("span", { className: "dataviews-field-control__label", children: label || field.label }),
            description && /* @__PURE__ */ (0, import_jsx_runtime61.jsx)("span", { className: "dataviews-field-control__sub-label", children: description })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(
            import_components24.__experimentalHStack,
            {
              ...
              children: [
                isVisible2 && /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_jsx_runtime61.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
                    import_components24.Button,
                    {
                ...
                onToggleVisibility && /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
                  import_components24.Button,
                  {
                ...
                previewOptions && /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
                  PreviewOptions,
                  {
                    previewOptions,
                    onChangePreviewOption,
  ...
  function FieldControl() {
    ...
    if (previewFields.length > 1) {
      ...
      previewFieldUI = isDefined2(previewField) && /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
        FieldItem,
        {
          field: previewField,
          label: (0, import_i18n25.__)("Preview"),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_components24.__experimentalVStack, { className: "dataviews-field-control", spacing: 6, children: [
      /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components24.__experimentalVStack, { className: "dataviews-view-config__properties", spacing: 0, children: (visibleLockedFields.length > 0 || !!visibleFields?.length) && /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_components24.__experimentalItemGroup, { isBordered: true, isSeparated: true, children: [
        visibleLockedFields.map(
          ({ field, isVisibleFlag, ui }) => {
            return ui ?? /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
              FieldItem,
              {
                field,
                isVisible: true,
        ...
        visibleFields.map((field, index) => /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
          RegularFieldItem,
          {
            field,
            view,
      ...
      (!!hiddenFields?.length || !!hiddenLockedFields.length) && /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_components24.__experimentalVStack, { spacing: 4, children: [
        /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components24.BaseControl.VisualLabel, { style: { margin: 0 }, children: (0, import_i18n25.__)("Hidden") }),
        /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
          import_components24.__experimentalVStack,
          {
            className: "dataviews-view-config__properties",
            spacing: 0,
            children: /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_components24.__experimentalItemGroup, { isBordered: true, isSeparated: true, children: [
              ...
              hiddenFields.map((field) => /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
                RegularFieldItem,
                {
                  field,
                  view,
  ...
  function SettingsSection({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_components24.__experimentalGrid, { columns: 12, className: "dataviews-settings-section", gap: 4, children: [
      ...
      import_components24.Dropdown,
      {
        ...
        renderContent: () => /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
          import_components24.__experimentalDropdownContentWrapper,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_components24.__experimentalVStack, { className: "dataviews-view-config", spacing: 6, children: [
              /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(SettingsSection, { title: (0, import_i18n25.__)("Appearance"), children: [
                /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(import_components24.__experimentalHStack, { expanded: true, className: "is-divided-in-two", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(SettingsSection, { title: (0, import_i18n25.__)("Properties"), children: /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(FieldControl, {}) })
            ] })
          }
        )
      }
  ...
  function RelativeDateControl({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(
      import_components26.BaseControl,
      {
        ...
        label,
        hideLabelFromVision,
        children: /* @__PURE__ */ (0, import_jsx_runtime75.jsxs)(import_components26.__experimentalHStack, { spacing: 2.5, children: [
      ...
      ValidatedDateControl,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime77.jsx)(
          import_components28.BaseControl,
          {
            ...
            label: displayLabel,
            hideLabelFromVision,
            children: /* @__PURE__ */ (0, import_jsx_runtime77.jsxs)(import_components28.__experimentalVStack, { spacing: 4, children: [
              /* @__PURE__ */ (0, import_jsx_runtime77.jsxs)(import_components28.__experimentalHStack, { spacing: 2, wrap: true, justify: "flex-start", children: [
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime77.jsx)(
          import_components28.BaseControl,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime77.jsxs)(import_components28.__experimentalVStack, { spacing: 4, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime77.jsxs)(import_components28.__experimentalHStack, { spacing: 2, children: [
                /* @__PURE__ */ (0, import_jsx_runtime77.jsx)(
                  import_components28.__experimentalInputControl,
                  {
                    __next40pxDefaultSize: true,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(
      ValidatedText,
      {
        ...{
          ...
          validity,
          type: "email",
          prefix: /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(import_components30.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(import_components30.Icon, { icon: at_symbol_default }) })
        }
      }
    );
  }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
      ValidatedText,
      {
        ...{
          ...
          validity,
          type: "tel",
          prefix: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(import_components31.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(import_components31.Icon, { icon: mobile_default }) })
        }
      }
    );
  }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(
      ValidatedText,
      {
        ...{
          ...
          validity,
          type: "url",
          prefix: /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(import_components32.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(import_components32.Icon, { icon: link_default }) })
        }
      }
    );
  }
  ...
  function BetweenControls({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(
      import_components33.BaseControl,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime82.jsxs)(import_components33.Flex, { direction: "row", gap: 4, children: [
  ...
  function Select({
    ...
    if (isLoading) {
      return /* @__PURE__ */ (0, import_jsx_runtime86.jsx)(import_components35.Spinner, {});
    }
  ...
  function ArrayControl({
    ...
    if (isLoading) {
      return /* @__PURE__ */ (0, import_jsx_runtime91.jsx)(import_components39.Spinner, {});
    }
  ...
  var ColorPicker = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(
      ...
      {
        renderToggle: ({ onToggle, isOpen }) => /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(import_components40.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(
          "button",
          {
            type: "button",
            onClick: onToggle,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(
      ValidatedText,
      {
        ...{
          ...
          suffix: /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(
            import_components41.Button,
            {
              ...
              size: "small",
              variant: "tertiary",
              "aria-label": isVisible2 ? (0, import_i18n36.__)("Hide password") : (0, import_i18n36.__)("Show password")
            }
          )
        }
      }
  ...
  function DataViews({
    ...
    const [selectionState, setSelectionState] = (0, import_element45.useState)([]);
    ...
    const _selection = (0, import_element45.useMemo)(() => {
  ...
  var defaultGetItemId2 = (item) => item.id;
  var EMPTY_ARRAY7 = [];
  function DefaultUI2({
    search = true,
    searchLabel = void 0
  ...
  function DataViewsPicker({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime96.jsx)(
      dataviews_context_default.Provider,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime96.jsx)("div", { className: "dataviews-picker-wrapper", ref: containerRef, children: children ?? /* @__PURE__ */ (0, import_jsx_runtime96.jsx)(DefaultUI2, { search, searchLabel }) })
      }
    );
  }
  ...
  var DataFormContext = (0, import_element47.createContext)({
    fields: []
  });
  ...
  function DataFormProvider({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime97.jsx)(DataFormContext.Provider, { value: { fields }, children });
  }
  ...
  function Header({ title }) {
    return /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(import_components44.__experimentalVStack, { className: "dataforms-layouts-regular__header", spacing: 4, children: /* @__PURE__ */ (0, import_jsx_runtime98.jsxs)(import_components44.__experimentalHStack, { alignment: "center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(import_components44.__experimentalHeading, { level: 2, size: 13, children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(import_components44.__experimentalSpacer, {})
    ] }) });
  }
  function FormRegularField({
    ...
    if (isCombinedField(field)) {
      return /* @__PURE__ */ (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [
        !hideLabelFromVision && field.label && /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(Header, { title: field.label }),
    ...
    if (labelPosition === "side") {
      return /* @__PURE__ */ (0, import_jsx_runtime98.jsxs)(import_components44.__experimentalHStack, { className: "dataforms-layouts-regular__field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(
          "div",
          {
            className: clsx_default(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime98.jsx)("div", { className: "dataforms-layouts-regular__field-control", children: fieldDefinition.readOnly === true ? /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime98.jsx)("div", { className: "dataforms-layouts-regular__field", children: fieldDefinition.readOnly === true ? /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(import_jsx_runtime98.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [
      !hideLabelFromVision && labelPosition !== "none" && /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(import_components44.BaseControl.VisualLabel, { children: fieldDefinition.label }),
      /* @__PURE__ */ (0, import_jsx_runtime98.jsx)(
        fieldDefinition.render,
        {
          item: data,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime99.jsx)(
      import_components45.Button,
      {
        ...
        "aria-label": (0, import_i18n37.sprintf)(
          ...
          (0, import_i18n37._x)("Edit %s", "field"),
          fieldLabel || ""
        ),
        onClick,
        disabled,
  ...
  function DropdownHeader({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(
      import_components46.__experimentalVStack,
      {
        ...
        spacing: 4,
        children: /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(import_components46.__experimentalHStack, { alignment: "center", children: [
          title && /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(import_components46.__experimentalHeading, { level: 2, size: 13, children: title }),
          /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(import_components46.__experimentalSpacer, {}),
          onClose && /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(
            import_components46.Button,
            {
              label: (0, import_i18n38.__)("Close"),
              icon: close_small_default,
              onClick: onClose,
              size: "small"
            }
  ...
  function PanelDropdown({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(
      import_components46.Dropdown,
      {
        ...
        renderToggle: ({ isOpen, onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(
        ...
        renderContent: ({ onClose }) => /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(import_jsx_runtime100.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(DropdownHeader, { title: fieldLabel, onClose }),
          /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(
            DataFormLayout,
            {
              ...
              children: (FieldLayout, childField, childFieldValidity) => /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(
                FieldLayout,
                {
                  data,
                  field: childField,
  ...
  function useFormValidity(item, fields, form) {
    const [formValidity, setFormValidity] = (0, import_element50.useState)();
    const previousValidatedValuesRef = (0, import_element50.useRef)({});
    const customValidationCounterRef = (0, import_element50.useRef)({});
    const elementsValidationCounterRef = (0, import_element50.useRef)(
      {}
    );
    const validate = (0, import_element50.useCallback)(() => {
      ...
      fieldsToValidate.forEach((field) => {
        ...
        try {
          ...
          if (error instanceof Error) {
            ...
            errorMessage = String(error) || (0, import_i18n39.__)("Unknown error when running custom validation.");
          }
          updateFieldValidity(setFormValidity, parentFieldId, field.id, {
            custom: {
              type: "invalid",
  ...
  function ModalContent({
    ...
    const [changes, setChanges] = (0, import_element51.useState)({});
    const modalData = (0, import_element51.useMemo)(() => {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(
            DataFormLayout,
            {
              ...
              validity,
              children: (FieldLayout, childField, childFieldValidity) => /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(
                FieldLayout,
                {
                  data: modalData,
                  field: childField,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime101.jsxs)(
            import_components47.__experimentalHStack,
            {
              ...
              spacing: 3,
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(import_components47.__experimentalSpacer, {}),
                /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(
                ...
                /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(
                  import_components47.Button,
                  {
                    ...
                    onClick: onApply,
                    __next40pxDefaultSize: true,
                    children: (0, import_i18n40.__)("Apply")
                  }
                )
              ]
            }
  ...
  function PanelModal({
    ...
    const [isOpen, setIsOpen] = (0, import_element51.useState)(false);
    const fieldLabel = isCombinedField(field) ? field.label : fieldDefinition?.label;
    return /* @__PURE__ */ (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [
      ...
      isOpen && /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(
        ModalContent,
        {
          data,
          field,
  ...
  function FormPanelField({
    ...
    const [popoverAnchor, setPopoverAnchor] = (0, import_element52.useState)(
      null
    );
    ...
    const fieldLabel = isCombinedField(field) ? field.label : fieldDefinition?.label;
    const renderedControl = layout.openAs === "modal" ? /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(
      modal_default,
      {
        data,
        field,
    ...
    if (labelPosition === "top") {
      return /* @__PURE__ */ (0, import_jsx_runtime102.jsxs)(import_components48.__experimentalVStack, { className: "dataforms-layouts-panel__field", spacing: 0, children: [
        /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(
          "div",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime102.jsx)("div", { className: "dataforms-layouts-panel__field-control", children: renderedControl })
      ] });
    }
    if (labelPosition === "none") {
      return /* @__PURE__ */ (0, import_jsx_runtime102.jsx)("div", { className: "dataforms-layouts-panel__field", children: renderedControl });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime102.jsxs)(
      import_components48.__experimentalHStack,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime102.jsx)("div", { className: labelClassName, children: fieldLabel }),
          /* @__PURE__ */ (0, import_jsx_runtime102.jsx)("div", { className: "dataforms-layouts-panel__field-control", children: renderedControl })
        ]
      }
    );
  ...
  function useCollapsibleCard(initialIsOpen = true) {
    const [isOpen, setIsOpen] = (0, import_element53.useState)(initialIsOpen);
    const toggle = (0, import_element53.useCallback)(() => {
      setIsOpen((prev) => !prev);
    }, []);
    const CollapsibleCardHeader = (0, import_element53.useCallback)(
      ({
        children,
        ...props
      }) => /* @__PURE__ */ (0, import_jsx_runtime103.jsxs)(
        import_components49.CardHeader,
        {
          ...props,
          onClick: toggle,
          style: {
  ...
  function FormCardField({
    ...
    const { fields } = (0, import_element53.useContext)(dataform_context_default);
    const layout = normalizeLayout({
      ...field.layout,
      type: "card"
    });
    ...
    if (isCombinedField(field)) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime103.jsxs)(import_components49.Card, { className: "dataforms-layouts-card__field", children: [
        withHeader2 && /* @__PURE__ */ (0, import_jsx_runtime103.jsxs)(CollapsibleCardHeader, { className: "dataforms-layouts-card__field-header", children: [
          /* @__PURE__ */ (0, import_jsx_runtime103.jsx)("span", { className: "dataforms-layouts-card__field-header-label", children: field.label }),
          visibleSummaryFields.length > 0 && layout.withHeader && /* @__PURE__ */ (0, import_jsx_runtime103.jsx)("div", { className: "dataforms-layouts-card__field-summary", children: visibleSummaryFields.map(
            (summaryField) => /* @__PURE__ */ (0, import_jsx_runtime103.jsx)(
              summaryField.render,
              {
                item: data,
                field: summaryField
        ...
        /* @__PURE__ */ (0, import_jsx_runtime103.jsxs)(import_components49.CardBody, { className: "dataforms-layouts-card__field-control", children: [
          field.description && /* @__PURE__ */ (0, import_jsx_runtime103.jsx)("div", { className: "dataforms-layouts-card__field-description", children: field.description }),
          /* @__PURE__ */ (0, import_jsx_runtime103.jsx)(
            DataFormLayout,
            {
              data,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime103.jsxs)(import_components49.Card, { className: "dataforms-layouts-card__field", children: [
      withHeader && /* @__PURE__ */ (0, import_jsx_runtime103.jsxs)(CollapsibleCardHeader, { className: "dataforms-layouts-card__field-header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime103.jsx)("span", { className: "dataforms-layouts-card__field-header-label", children: fieldDefinition.label }),
        visibleSummaryFields.length > 0 && layout.withHeader && /* @__PURE__ */ (0, import_jsx_runtime103.jsx)("div", { className: "dataforms-layouts-card__field-summary", children: visibleSummaryFields.map((summaryField) => /* @__PURE__ */ (0, import_jsx_runtime103.jsx)(
          summaryField.render,
          {
            item: data,
            field: summaryField
      ...
      // Otherwise, the card will not be visible.
      /* @__PURE__ */ (0, import_jsx_runtime103.jsx)(import_components49.CardBody, { className: "dataforms-layouts-card__field-control", children: /* @__PURE__ */ (0, import_jsx_runtime103.jsx)(
        RegularLayout,
        {
          data,
          field,
  ...
  function Header2({ title }) {
    return /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_components50.__experimentalVStack, { className: "dataforms-layouts-row__header", spacing: 4, children: /* @__PURE__ */ (0, import_jsx_runtime104.jsxs)(import_components50.__experimentalHStack, { alignment: "center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_components50.__experimentalHeading, { level: 2, size: 13, children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_components50.__experimentalSpacer, {})
    ] }) });
  }
  var EMPTY_WRAPPER = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_jsx_runtime104.Fragment, { children });
  function FormRowField({
    ...
    if (isCombinedField(field)) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime104.jsxs)("div", { className: "dataforms-layouts-row__field", children: [
        !hideLabelFromVision && field.label && /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(Header2, { title: field.label }),
        /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_components50.__experimentalHStack, { alignment: layout.alignment, spacing: 4, children: /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(
          DataFormLayout,
          {
            data,
            form,
            ...
            validity: validity?.children,
            as: EMPTY_WRAPPER,
            children: (FieldLayout, childField, childFieldValidity) => /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(
              "div",
              {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_jsx_runtime104.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime104.jsx)("div", { className: "dataforms-layouts-row__field-control", children: /* @__PURE__ */ (0, import_jsx_runtime104.jsx)(
      RegularLayout,
      {
        data,
        field: fieldDefinition,
  ...
  var FORM_FIELD_LAYOUTS = [
    {
      ...
      wrapper: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(import_components51.__experimentalVStack, { className: "dataforms-layouts__wrapper", spacing: 4, children })
    },
    {
      type: "panel",
      component: FormPanelField,
      wrapper: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(import_components51.__experimentalVStack, { className: "dataforms-layouts__wrapper", spacing: 2, children })
    },
    {
      type: "card",
      component: FormCardField,
      wrapper: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(import_components51.__experimentalVStack, { className: "dataforms-layouts__wrapper", spacing: 6, children })
    },
    {
      type: "row",
      ...
      wrapper: ({
        children,
        layout
      }) => /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(import_components51.__experimentalVStack, { className: "dataforms-layouts__wrapper", spacing: 4, children: /* @__PURE__ */ (0, import_jsx_runtime105.jsx)("div", { className: "dataforms-layouts-row__field", children: /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(
  ...
  // packages/dataviews/build-module/dataform-layouts/data-form-layout.js
  var DEFAULT_WRAPPER = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime106.jsx)(import_components52.__experimentalVStack, { className: "dataforms-layouts__wrapper", spacing: 4, children });
  function DataFormLayout({
    ...
    const { fields: fieldDefinitions } = (0, import_element55.useContext)(dataform_context_default);
    ...
    const normalizedFormFields = (0, import_element55.useMemo)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime106.jsx)(Wrapper, { layout: normalizedFormLayout, children: normalizedFormFields.map((formField) => {
  ...
  function DataForm({
    ...
    const normalizedFields = (0, import_element56.useMemo)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime107.jsx)(DataFormProvider, { fields: normalizedFields, children: /* @__PURE__ */ (0, import_jsx_runtime107.jsx)(
      DataFormLayout,
      {
        data,
        form,
      ...
      view.filters.forEach((filter) => {
        ...
        if (field) {
          if (filter.operator === OPERATOR_IS_ANY && filter?.value?.length > 0) {
            ...
            const filterDate = (0, import_date6.getDate)(filter.value);
            filteredData = filteredData.filter((item) => {
            ...
            const filterValue = (0, import_date6.getDate)(filter.value);
            filteredData = filteredData.filter((item) => {
              const fieldValue = (0, import_date6.getDate)(
                field.getValue({ item })
              );
