...
`)):n=n.replace(/  +\n/g,`<br />
`),n=o.converter._dispatch("spanGamut.after",n,i,o),n}),r.subParser("strikethrough",function(n,i,o){"use strict";function d(p){return i.simplifiedAutoLink&&(p=r.subParser("simplifiedAutoLinks")(p,i,o)),"<del>"+p+"</del>"}return i.strikethrough&&(n=o.converter._dispatch("strikethrough.before",n,i,o),n=n.replace(/(?:~){2}([\s\S]+?)(?:~){2}/g,function(p,m){return d(m)}),n=o.converter._dispatch("strikethrough.after",n,i,o)),n}),r.subParser("stripLinkDefinitions",function(n,i,o){"use strict";var d=/^ {0,3}\[(.+)]:[ \t]*\n?[ \t]*<?([^>\s]+)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*\n?[ \t]*(?:(\n*)["|'(](.+?)["|')][ \t]*)?(?:\n+|(?=¨0))/gm,p=/^ {0,3}\[(.+)]:[ \t]*\n?[ \t]*<?(data:.+?\/.+?;base64,[A-Za-z0-9+/=\n]+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*\n?[ \t]*(?:(\n*)["|'(](.+?)["|')][ \t]*)?(?:\n\n|(?=¨0)|(?=\n\[))/gm;n+="\xA80";var m=function(f,g,T,k,w,v,l){return g=g.toLowerCase(),T.match(/^data:.+?\/.+?;base64,/)?o.gUrls[g]=T.replace(/\s/g,""):o.gUrls[g]=r.subParser("encodeAmpsAndAngles")(T,i,o),v?v+l:(l&&(o.gTitles[g]=l.replace(/"|'/g,"&quot;")),i.parseImgDimensions&&k&&w&&(o.gDimensions[g]={width:k,height:w}),"")};return n=n.replace(p,m),n=n.replace(d,m),n=n.replace(/¨0/,""),n}),r.subParser("tables",function(n,i,o){"use strict";if(!i.tables)return n;var d=/^ {0,3}\|?.+\|.+\n {0,3}\|?[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:[-=]){2,}[\s\S]+?(?:\n\n|¨0)/gm,p=/^ {0,3}\|.+\|[ \t]*\n {0,3}\|[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*\n( {0,3}\|.+\|[ \t]*\n)*(?:\n|¨0)/gm;function m(w){return/^:[ \t]*--*$/.test(w)?' style="text-align:left;"':/^--*[ \t]*:[ \t]*$/.test(w)?' style="text-align:right;"':/^:[ \t]*--*[ \t]*:$/.test(w)?' style="text-align:center;"':""}function f(w,v){var l="";return w=w.trim(),(i.tablesHeaderId||i.tableHeaderId)&&(l=' id="'+w.replace(/ /g,"_").toLowerCase()+'"'),w=r.subParser("spanGamut")(w,i,o),"<th"+l+v+">"+w+`</th>
`}function g(w,v){var l=r.subParser("spanGamut")(w,i,o);return"<td"+v+">"+l+`</td>
...
`}return o.trim()}),r.subParser("makeMarkdown.tableCell",function(n,i){"use strict";var o="";if(!n.hasChildNodes())return"";for(var d=n.childNodes,p=d.length,m=0;m<p;++m)o+=r.subParser("makeMarkdown.node")(d[m],i,!0);return o.trim()}),r.subParser("makeMarkdown.txt",function(n){"use strict";var i=n.nodeValue;return i=i.replace(/ +/g," "),i=i.replace(/¨NBSP;/g," "),i=r.helper.unescapeHTMLEntities(i),i=i.replace(/([*_~|`])/g,"\\$1"),i=i.replace(/^(\s*)>/g,"\\$1>"),i=i.replace(/^#/gm,"\\#"),i=i.replace(/^(\s*)([-=]{3,})(\s*)$/,"$1\\$2$3"),i=i.replace(/^( {0,3}\d+)\./gm,"$1\\."),i=i.replace(/^( {0,3})([+-])/gm,"$1\\$2"),i=i.replace(/]([\s]*)\(/g,"\\]$1\\("),i=i.replace(/^ {0,3}\[([\S \t]*?)]:/gm,"\\[$1]:"),i});var jo=this;typeof define=="function"&&define.amd?define(function(){"use strict";return r}):typeof Qr<"u"&&Qr.exports?Qr.exports=r:jo.showdown=r}).call(ho)});var Rd={};Ie(Rd,{__EXPERIMENTAL_ELEMENTS:()=>Vn,__EXPERIMENTAL_PATHS_WITH_OVERRIDE:()=>xn,__EXPERIMENTAL_STYLE_PROPERTY:()=>pe,__experimentalCloneSanitizedBlock:()=>Vt,__experimentalGetAccessibleBlockLabel:()=>_a,__experimentalGetBlockAttributesNamesByRole:()=>ya,__experimentalGetBlockLabel:()=>yt,__experimentalSanitizeBlockAttributes:()=>Ge,__unstableGetBlockProps:()=>Gt,__unstableGetInnerBlocksProps:()=>hu,__unstableSerializeAndClean:()=>gu,children:()=>Du,cloneBlock:()=>xt,createBlock:()=>U,createBlocksFromInnerBlocksTemplate:()=>It,doBlocksMatchTemplate:()=>fn,findTransform:()=>he,getBlockAttributes:()=>ie,getBlockAttributesNamesByRole:()=>vt,getBlockBindingsSource:()=>gt,getBlockBindingsSources:()=>ha,getBlockContent:()=>Xe,getBlockDefaultClassName:()=>fu,getBlockFromExample:()=>Ht,getBlockMenuDefaultClassName:()=>pu,getBlockSupport:()=>ta,getBlockTransforms:()=>oe,getBlockType:()=>M,getBlockTypes:()=>Ue,getBlockVariations:()=>ca,getCategories:()=>No,getChildBlockNames:()=>ua,getDefaultBlockName:()=>pr,getFreeformContentHandlerName:()=>ee,getGroupingBlockName:()=>fr,getPhrasingContentSchema:()=>So,getPossibleBlockTransformations:()=>Ja,getSaveContent:()=>ge,getSaveElement:()=>Kt,getUnregisteredTypeHandlerName:()=>me,hasBlockSupport:()=>se,hasChildBlocks:()=>oa,hasChildBlocksWithInserterSupport:()=>ia,isReusableBlock:()=>na,isTemplatePart:()=>aa,isUnmodifiedBlock:()=>_t,isUnmodifiedDefaultBlock:()=>hr,isValidBlockContent:()=>Pu,isValidIcon:()=>$e,node:()=>Mu,normalizeIconObject:()=>gr,parse:()=>Ee,parseWithAttributeSchema:()=>Le,pasteHandler:()=>et,privateApis:()=>Do,rawHandler:()=>ln,registerBlockBindingsSource:()=>pa,registerBlockCollection:()=>Xn,registerBlockStyle:()=>sa,registerBlockType:()=>Yn,registerBlockVariation:()=>la,serialize:()=>Mr,serializeRawBlock:()=>we,setCategories:()=>Lo,setDefaultBlockName:()=>ea,setFreeformContentHandlerName:()=>Qn,setGroupingBlockName:()=>ra,setUnregisteredTypeHandlerName:()=>Jn,store:()=>P,switchToBlockType:()=>eu,synchronizeBlocksWithTemplate:()=>rt,unregisterBlockBindingsSource:()=>ma,unregisterBlockStyle:()=>da,unregisterBlockType:()=>Zn,unregisterBlockVariation:()=>fa,unstable__bootstrapServerSideBlockDefinitions:()=>Wn,updateCategory:()=>Po,validateBlock:()=>be,withBlockContentContext:()=>Pd});var Rr=B(Be(),1);var Oe=function(){return Oe=Object.assign||function(t){for(var r,a=1,u=arguments.length;a<u;a++){r=arguments[a];for(var s in r)Object.prototype.hasOwnProperty.call(r,s)&&(t[s]=r[s])}return t},Oe.apply(this,arguments)};function bn(e){return e.toLowerCase()}var Uo=[/([a-z0-9])([A-Z])/g,/([A-Z])([A-Z][a-z])/g],Fo=/[^A-Z0-9]+/gi;function yn(e,t){t===void 0&&(t={});for(var r=t.splitRegexp,a=r===void 0?Uo:r,u=t.stripRegexp,s=u===void 0?Fo:u,c=t.transform,h=c===void 0?bn:c,_=t.delimiter,b=_===void 0?" ":_,E=_n(_n(e,a,"$1\0$2"),s,"\0"),L=0,N=E.length;E.charAt(L)==="\0";)L++;for(;E.charAt(N-1)==="\0";)N--;return E.slice(L,N).split("\0").map(h).join(b)}function _n(e,t,r){return t instanceof RegExp?e.replace(t,r):t.reduce(function(a,u){return a.replace(u,r)},e)}function ut(e,t){var r=e.charAt(0),a=e.substr(1).toLowerCase();return t>0&&r>="0"&&r<="9"?"_"+r+a:""+r.toUpperCase()+a}function wn(e,t){return t===void 0&&(t={}),yn(e,Oe({delimiter:"",transform:ut},t))}function $o(e,t){return t===0?e.toLowerCase():ut(e,t)}function kn(e,t){return t===void 0&&(t={}),wn(e,Oe({transform:$o},t))}var ka=B(Be(),1),ye=B(sr(),1);var Go={grad:.9,turn:360,rad:360/(2*Math.PI)},fe=function(e){return typeof e=="string"?e.length>0:typeof e=="number"},V=function(e,t,r){return t===void 0&&(t=0),r===void 0&&(r=Math.pow(10,t)),Math.round(r*e)/r+0},Q=function(e,t,r){return t===void 0&&(t=0),r===void 0&&(r=1),e>r?r:e>t?e:t},Ln=function(e){return(e=isFinite(e)?e%360:0)>0?e:e+360},En=function(e){return{r:Q(e.r,0,255),g:Q(e.g,0,255),b:Q(e.b,0,255),a:Q(e.a)}},ot=function(e){return{r:V(e.r),g:V(e.g),b:V(e.b),a:V(e.a,3)}},Ko=/^#([0-9a-f]{3,8})$/i,dr=function(e){var t=e.toString(16);return t.length<2?"0"+t:t},Pn=function(e){var t=e.r,r=e.g,a=e.b,u=e.a,s=Math.max(t,r,a),c=s-Math.min(t,r,a),h=c?s===t?(r-a)/c:s===r?2+(a-t)/c:4+(t-r)/c:0;return{h:60*(h<0?h+6:h),s:s?c/s*100:0,v:s/255*100,a:u}},Rn=function(e){var t=e.h,r=e.s,a=e.v,u=e.a;t=t/360*6,r/=100,a/=100;var s=Math.floor(t),c=a*(1-r),h=a*(1-(t-s)*r),_=a*(1-(1-t+s)*r),b=s%6;return{r:255*[a,h,c,c,_,a][b],g:255*[_,a,a,h,c,c][b],b:255*[c,c,_,a,a,h][b],a:u}},Tn=function(e){return{h:Ln(e.h),s:Q(e.s,0,100),l:Q(e.l,0,100),a:Q(e.a)}},Cn=function(e){return{h:V(e.h),s:V(e.s),l:V(e.l),a:V(e.a,3)}},Bn=function(e){return Rn((r=(t=e).s,{h:t.h,s:(r*=((a=t.l)<50?a:100-a)/100)>0?2*r/(a+r)*100:0,v:a+r,a:t.a}));var t,r,a},Ve=function(e){return{h:(t=Pn(e)).h,s:(u=(200-(r=t.s))*(a=t.v)/100)>0&&u<200?r*a/100/(u<=100?u:200-u)*100:0,l:u/2,a:t.a};var t,r,a,u},Wo=/^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i,Yo=/^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i,Xo=/^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i,Zo=/^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i,dt={string:[[function(e){var t=Ko.exec(e);return t?(e=t[1]).length<=4?{r:parseInt(e[0]+e[0],16),g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16),a:e.length===4?V(parseInt(e[3]+e[3],16)/255,2):1}:e.length===6||e.length===8?{r:parseInt(e.substr(0,2),16),g:parseInt(e.substr(2,2),16),b:parseInt(e.substr(4,2),16),a:e.length===8?V(parseInt(e.substr(6,2),16)/255,2):1}:null:null},"hex"],[function(e){var t=Xo.exec(e)||Zo.exec(e);return t?t[2]!==t[4]||t[4]!==t[6]?null:En({r:Number(t[1])/(t[2]?100/255:1),g:Number(t[3])/(t[4]?100/255:1),b:Number(t[5])/(t[6]?100/255:1),a:t[7]===void 0?1:Number(t[7])/(t[8]?100:1)}):null},"rgb"],[function(e){var t=Wo.exec(e)||Yo.exec(e);if(!t)return null;var r,a,u=Tn({h:(r=t[1],a=t[2],a===void 0&&(a="deg"),Number(r)*(Go[a]||1)),s:Number(t[3]),l:Number(t[4]),a:t[5]===void 0?1:Number(t[5])/(t[6]?100:1)});return Bn(u)},"hsl"]],object:[[function(e){var t=e.r,r=e.g,a=e.b,u=e.a,s=u===void 0?1:u;return fe(t)&&fe(r)&&fe(a)?En({r:Number(t),g:Number(r),b:Number(a),a:Number(s)}):null},"rgb"],[function(e){var t=e.h,r=e.s,a=e.l,u=e.a,s=u===void 0?1:u;if(!fe(t)||!fe(r)||!fe(a))return null;var c=Tn({h:Number(t),s:Number(r),l:Number(a),a:Number(s)});return Bn(c)},"hsl"],[function(e){var t=e.h,r=e.s,a=e.v,u=e.a,s=u===void 0?1:u;if(!fe(t)||!fe(r)||!fe(a))return null;var c=(function(h){return{h:Ln(h.h),s:Q(h.s,0,100),v:Q(h.v,0,100),a:Q(h.a)}})({h:Number(t),s:Number(r),v:Number(a),a:Number(s)});return Rn(c)},"hsv"]]},An=function(e,t){for(var r=0;r<t.length;r++){var a=t[r][0](e);if(a)return[a,t[r][1]]}return[null,void 0]},Qo=function(e){return typeof e=="string"?An(e.trim(),dt.string):typeof e=="object"&&e!==null?An(e,dt.object):[null,void 0]};var it=function(e,t){var r=Ve(e);return{h:r.h,s:Q(r.s+100*t,0,100),l:r.l,a:r.a}},st=function(e){return(299*e.r+587*e.g+114*e.b)/1e3/255},Sn=function(e,t){var r=Ve(e);return{h:r.h,s:r.s,l:Q(r.l+100*t,0,100),a:r.a}},ct=(function(){function e(t){this.parsed=Qo(t)[0],this.rgba=this.parsed||{r:0,g:0,b:0,a:1}}return e.prototype.isValid=function(){return this.parsed!==null},e.prototype.brightness=function(){return V(st(this.rgba),2)},e.prototype.isDark=function(){return st(this.rgba)<.5},e.prototype.isLight=function(){return st(this.rgba)>=.5},e.prototype.toHex=function(){return t=ot(this.rgba),r=t.r,a=t.g,u=t.b,c=(s=t.a)<1?dr(V(255*s)):"","#"+dr(r)+dr(a)+dr(u)+c;var t,r,a,u,s,c},e.prototype.toRgb=function(){return ot(this.rgba)},e.prototype.toRgbString=function(){return t=ot(this.rgba),r=t.r,a=t.g,u=t.b,(s=t.a)<1?"rgba("+r+", "+a+", "+u+", "+s+")":"rgb("+r+", "+a+", "+u+")";var t,r,a,u,s},e.prototype.toHsl=function(){return Cn(Ve(this.rgba))},e.prototype.toHslString=function(){return t=Cn(Ve(this.rgba)),r=t.h,a=t.s,u=t.l,(s=t.a)<1?"hsla("+r+", "+a+"%, "+u+"%, "+s+")":"hsl("+r+", "+a+"%, "+u+"%)";var t,r,a,u,s},e.prototype.toHsv=function(){return t=Pn(this.rgba),{h:V(t.h),s:V(t.s),v:V(t.v),a:V(t.a,3)};var t},e.prototype.invert=function(){return ae({r:255-(t=this.rgba).r,g:255-t.g,b:255-t.b,a:t.a});var t},e.prototype.saturate=function(t){return t===void 0&&(t=.1),ae(it(this.rgba,t))},e.prototype.desaturate=function(t){return t===void 0&&(t=.1),ae(it(this.rgba,-t))},e.prototype.grayscale=function(){return ae(it(this.rgba,-1))},e.prototype.lighten=function(t){return t===void 0&&(t=.1),ae(Sn(this.rgba,t))},e.prototype.darken=function(t){return t===void 0&&(t=.1),ae(Sn(this.rgba,-t))},e.prototype.rotate=function(t){return t===void 0&&(t=15),this.hue(this.hue()+t)},e.prototype.alpha=function(t){return typeof t=="number"?ae({r:(r=this.rgba).r,g:r.g,b:r.b,a:t}):V(this.rgba.a,3);var r},e.prototype.hue=function(t){var r=Ve(this.rgba);return typeof t=="number"?ae({h:t,s:r.s,l:r.l,a:r.a}):V(r.h)},e.prototype.isEqual=function(t){return this.toHex()===ae(t).toHex()},e})(),ae=function(e){return e instanceof ct?e:new ct(e)},Nn=[],On=function(e){e.forEach(function(t){Nn.indexOf(t)<0&&(t(ct,dt),Nn.push(t))})};function Dn(e,t){var r={white:"#ffffff",bisque:"#ffe4c4",blue:"#0000ff",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",antiquewhite:"#faebd7",aqua:"#00ffff",azure:"#f0ffff",whitesmoke:"#f5f5f5",papayawhip:"#ffefd5",plum:"#dda0dd",blanchedalmond:"#ffebcd",black:"#000000",gold:"#ffd700",goldenrod:"#daa520",gainsboro:"#dcdcdc",cornsilk:"#fff8dc",cornflowerblue:"#6495ed",burlywood:"#deb887",aquamarine:"#7fffd4",beige:"#f5f5dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkkhaki:"#bdb76b",darkgray:"#a9a9a9",darkgreen:"#006400",darkgrey:"#a9a9a9",peachpuff:"#ffdab9",darkmagenta:"#8b008b",darkred:"#8b0000",darkorchid:"#9932cc",darkorange:"#ff8c00",darkslateblue:"#483d8b",gray:"#808080",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",deeppink:"#ff1493",deepskyblue:"#00bfff",wheat:"#f5deb3",firebrick:"#b22222",floralwhite:"#fffaf0",ghostwhite:"#f8f8ff",darkviolet:"#9400d3",magenta:"#ff00ff",green:"#008000",dodgerblue:"#1e90ff",grey:"#808080",honeydew:"#f0fff0",hotpink:"#ff69b4",blueviolet:"#8a2be2",forestgreen:"#228b22",lawngreen:"#7cfc00",indianred:"#cd5c5c",indigo:"#4b0082",fuchsia:"#ff00ff",brown:"#a52a2a",maroon:"#800000",mediumblue:"#0000cd",lightcoral:"#f08080",darkturquoise:"#00ced1",lightcyan:"#e0ffff",ivory:"#fffff0",lightyellow:"#ffffe0",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",linen:"#faf0e6",mediumaquamarine:"#66cdaa",lemonchiffon:"#fffacd",lime:"#00ff00",khaki:"#f0e68c",mediumseagreen:"#3cb371",limegreen:"#32cd32",mediumspringgreen:"#00fa9a",lightskyblue:"#87cefa",lightblue:"#add8e6",midnightblue:"#191970",lightpink:"#ffb6c1",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",mintcream:"#f5fffa",lightslategray:"#778899",lightslategrey:"#778899",navajowhite:"#ffdead",navy:"#000080",mediumvioletred:"#c71585",powderblue:"#b0e0e6",palegoldenrod:"#eee8aa",oldlace:"#fdf5e6",paleturquoise:"#afeeee",mediumturquoise:"#48d1cc",mediumorchid:"#ba55d3",rebeccapurple:"#663399",lightsteelblue:"#b0c4de",mediumslateblue:"#7b68ee",thistle:"#d8bfd8",tan:"#d2b48c",orchid:"#da70d6",mediumpurple:"#9370db",purple:"#800080",pink:"#ffc0cb",skyblue:"#87ceeb",springgreen:"#00ff7f",palegreen:"#98fb98",red:"#ff0000",yellow:"#ffff00",slateblue:"#6a5acd",lavenderblush:"#fff0f5",peru:"#cd853f",palevioletred:"#db7093",violet:"#ee82ee",teal:"#008080",slategray:"#708090",slategrey:"#708090",aliceblue:"#f0f8ff",darkseagreen:"#8fbc8f",darkolivegreen:"#556b2f",greenyellow:"#adff2f",seagreen:"#2e8b57",seashell:"#fff5ee",tomato:"#ff6347",silver:"#c0c0c0",sienna:"#a0522d",lavender:"#e6e6fa",lightgreen:"#90ee90",orange:"#ffa500",orangered:"#ff4500",steelblue:"#4682b4",royalblue:"#4169e1",turquoise:"#40e0d0",yellowgreen:"#9acd32",salmon:"#fa8072",saddlebrown:"#8b4513",sandybrown:"#f4a460",rosybrown:"#bc8f8f",darksalmon:"#e9967a",lightgoldenrodyellow:"#fafad2",snow:"#fffafa",lightgrey:"#d3d3d3",lightgray:"#d3d3d3",dimgray:"#696969",dimgrey:"#696969",olivedrab:"#6b8e23",olive:"#808000"},a={};for(var u in r)a[r[u]]=u;var s={};e.prototype.toName=function(c){if(!(this.rgba.a||this.rgba.r||this.rgba.g||this.rgba.b))return"transparent";var h,_,b=a[this.toHex()];if(b)return b;if(c?.closest){var E=this.toRgb(),L=1/0,N="black";if(!s.length)for(var j in r)s[j]=new e(r[j]).toRgb();for(var I in r){var G=(h=E,_=s[I],Math.pow(h.r-_.r,2)+Math.pow(h.g-_.g,2)+Math.pow(h.b-_.b,2));G<L&&(L=G,N=I)}return N}},t.string.push([function(c){var h=c.toLowerCase(),_=h==="transparent"?"#0000":r[h];return _?new e(_).toRgb():null},"name"])}var lt=function(e){var t=e/255;return t<.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)},ft=function(e){return .2126*lt(e.r)+.7152*lt(e.g)+.0722*lt(e.b)};function Mn(e){e.prototype.luminance=function(){return t=ft(this.rgba),(r=2)===void 0&&(r=0),a===void 0&&(a=Math.pow(10,r)),Math.round(a*t)/a+0;var t,r,a},e.prototype.contrast=function(t){t===void 0&&(t="#FFF");var r,a,u,s,c,h,_,b=t instanceof e?t:new e(t);return s=this.rgba,c=b.toRgb(),h=ft(s),_=ft(c),r=h>_?(h+.05)/(_+.05):(_+.05)/(h+.05),(a=2)===void 0&&(a=0),u===void 0&&(u=Math.pow(10,a)),Math.floor(u*r)/u+0},e.prototype.isReadable=function(t,r){return t===void 0&&(t="#FFF"),r===void 0&&(r={}),this.contrast(t)>=(h=(c=(a=r).size)===void 0?"normal":c,(s=(u=a.level)===void 0?"AA":u)==="AAA"&&h==="normal"?7:s==="AA"&&h==="large"?3:4.5);var a,u,s,c,h}}var mr=B(De(),1),W=B(sr(),1),ba=B(Z(),1),Fe=B(xe(),1),bt=B(J(),1);var cr="block-default",He=["attributes","supports","save","migrate","isEligible","apiVersion"],pe={"--wp--style--color--link":{value:["color","link"],support:["color","link"]},aspectRatio:{value:["dimensions","aspectRatio"],support:["dimensions","aspectRatio"],useEngine:!0},background:{value:["color","gradient"],support:["color","gradients"],useEngine:!0},backgroundColor:{value:["color","background"],support:["color","background"],requiresOptOut:!0,useEngine:!0},backgroundImage:{value:["background","backgroundImage"],support:["background","backgroundImage"],useEngine:!0},backgroundRepeat:{value:["background","backgroundRepeat"],support:["background","backgroundRepeat"],useEngine:!0},backgroundSize:{value:["background","backgroundSize"],support:["background","backgroundSize"],useEngine:!0},backgroundPosition:{value:["background","backgroundPosition"],support:["background","backgroundPosition"],useEngine:!0},borderColor:{value:["border","color"],support:["__experimentalBorder","color"],useEngine:!0},borderRadius:{value:["border","radius"],support:["__experimentalBorder","radius"],properties:{borderTopLeftRadius:"topLeft",borderTopRightRadius:"topRight",borderBottomLeftRadius:"bottomLeft",borderBottomRightRadius:"bottomRight"},useEngine:!0},borderStyle:{value:["border","style"],support:["__experimentalBorder","style"],useEngine:!0},borderWidth:{value:["border","width"],support:["__experimentalBorder","width"],useEngine:!0},borderTopColor:{value:["border","top","color"],support:["__experimentalBorder","color"],useEngine:!0},borderTopStyle:{value:["border","top","style"],support:["__experimentalBorder","style"],useEngine:!0},borderTopWidth:{value:["border","top","width"],support:["__experimentalBorder","width"],useEngine:!0},borderRightColor:{value:["border","right","color"],support:["__experimentalBorder","color"],useEngine:!0},borderRightStyle:{value:["border","right","style"],support:["__experimentalBorder","style"],useEngine:!0},borderRightWidth:{value:["border","right","width"],support:["__experimentalBorder","width"],useEngine:!0},borderBottomColor:{value:["border","bottom","color"],support:["__experimentalBorder","color"],useEngine:!0},borderBottomStyle:{value:["border","bottom","style"],support:["__experimentalBorder","style"],useEngine:!0},borderBottomWidth:{value:["border","bottom","width"],support:["__experimentalBorder","width"],useEngine:!0},borderLeftColor:{value:["border","left","color"],support:["__experimentalBorder","color"],useEngine:!0},borderLeftStyle:{value:["border","left","style"],support:["__experimentalBorder","style"],useEngine:!0},borderLeftWidth:{value:["border","left","width"],support:["__experimentalBorder","width"],useEngine:!0},color:{value:["color","text"],support:["color","text"],requiresOptOut:!0,useEngine:!0},columnCount:{value:["typography","textColumns"],support:["typography","textColumns"],useEngine:!0},filter:{value:["filter","duotone"],support:["filter","duotone"]},linkColor:{value:["elements","link","color","text"],support:["color","link"]},captionColor:{value:["elements","caption","color","text"],support:["color","caption"]},buttonColor:{value:["elements","button","color","text"],support:["color","button"]},buttonBackgroundColor:{value:["elements","button","color","background"],support:["color","button"]},headingColor:{value:["elements","heading","color","text"],support:["color","heading"]},headingBackgroundColor:{value:["elements","heading","color","background"],support:["color","heading"]},fontFamily:{value:["typography","fontFamily"],support:["typography","__experimentalFontFamily"],useEngine:!0},fontSize:{value:["typography","fontSize"],support:["typography","fontSize"],useEngine:!0},fontStyle:{value:["typography","fontStyle"],support:["typography","__experimentalFontStyle"],useEngine:!0},fontWeight:{value:["typography","fontWeight"],support:["typography","__experimentalFontWeight"],useEngine:!0},lineHeight:{value:["typography","lineHeight"],support:["typography","lineHeight"],useEngine:!0},margin:{value:["spacing","margin"],support:["spacing","margin"],properties:{marginTop:"top",marginRight:"right",marginBottom:"bottom",marginLeft:"left"},useEngine:!0},minHeight:{value:["dimensions","minHeight"],support:["dimensions","minHeight"],useEngine:!0},height:{value:["dimensions","height"],support:["dimensions","height"],useEngine:!0},width:{value:["dimensions","width"],support:["dimensions","width"],useEngine:!0},padding:{value:["spacing","padding"],support:["spacing","padding"],properties:{paddingTop:"top",paddingRight:"right",paddingBottom:"bottom",paddingLeft:"left"},useEngine:!0},textAlign:{value:["typography","textAlign"],support:["typography","textAlign"],useEngine:!1},textDecoration:{value:["typography","textDecoration"],support:["typography","__experimentalTextDecoration"],useEngine:!0},textTransform:{value:["typography","textTransform"],support:["typography","__experimentalTextTransform"],useEngine:!0},letterSpacing:{value:["typography","letterSpacing"],support:["typography","__experimentalLetterSpacing"],useEngine:!0},textIndent:{value:["typography","textIndent"],support:["typography","textIndent"],useEngine:!0},writingMode:{value:["typography","writingMode"],support:["typography","__experimentalWritingMode"],useEngine:!0},"--wp--style--root--padding":{value:["spacing","padding"],support:["spacing","padding"],properties:{"--wp--style--root--padding-top":"top","--wp--style--root--padding-right":"right","--wp--style--root--padding-bottom":"bottom","--wp--style--root--padding-left":"left"},rootOnly:!0}},Vn={link:"a:where(:not(.wp-element-button))",heading:"h1, h2, h3, h4, h5, h6",h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",button:".wp-element-button, .wp-block-button__link",caption:".wp-element-caption, .wp-block-audio figcaption, .wp-block-embed figcaption, .wp-block-gallery figcaption, .wp-block-image figcaption, .wp-block-table figcaption, .wp-block-video figcaption",cite:"cite",select:"select",textInput:"textarea, input:where([type=email],[type=number],[type=password],[type=search],[type=tel],[type=text],[type=url])"},xn={"color.duotone":!0,"color.gradients":!0,"color.palette":!0,"dimensions.aspectRatios":!0,"typography.fontSizes":!0,"spacing.spacingSizes":!0};var R=B(Be(),1),Kn=B(sr(),1),q=B(pt(),1);var mt={title:"block title",description:"block description",keywords:["block keyword"],styles:[{label:"block style label"}],variations:[{title:"block variation title",description:"block variation description",keywords:["block variation keyword"]}]};var $n=B(Fn(),1),{lock:Gn,unlock:ue}=(0,$n.__dangerousOptInToUnstableAPIsOnlyForCoreModules)("I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of Retraceur.","@wordpress/blocks");function lr(e){return e!==null&&typeof e=="object"}function Wn(e){let{addBootstrappedBlockType:t}=ue((0,R.dispatch)(P));for(let[r,a]of Object.entries(e))t(r,a)}function ei({textdomain:e,...t}){let r=["apiVersion","title","category","parent","ancestor","icon","description","keywords","attributes","providesContext","usesContext","selectors","supports","styles","example","variations","blockHooks","allowedBlocks"],a=Object.fromEntries(Object.entries(t).filter(([u])=>r.includes(u)));return e&&Object.keys(mt).forEach(u=>{a[u]&&(a[u]=ht(mt[u],a[u],e))}),a}function Yn(e,t){let r=lr(e)?e.name:e;if(typeof r!="string"){(0,q.default)("Block names must be strings.");return}if(!/^[a-z][a-z0-9-]*\/[a-z][a-z0-9-]*$/.test(r)){(0,q.default)("Block names must contain a namespace prefix, include only lowercase alphanumeric characters or dashes, and start with a letter. Example: my-plugin/my-custom-block");return}if((0,R.select)(P).getBlockType(r)){(0,q.default)('Block "'+r+'" is already registered.');return}let{addBootstrappedBlockType:a,addUnprocessedBlockType:u}=ue((0,R.dispatch)(P));if(lr(e)){let s=ei(e);a(r,s)}return u(r,t),(0,R.select)(P).getBlockType(r)}function ht(e,t,r){return typeof e=="string"&&typeof t=="string"?(0,Kn._x)(t,e,r):Array.isArray(e)&&e.length&&Array.isArray(t)?t.map(a=>ht(e[0],a,r)):lr(e)&&Object.entries(e).length&&lr(t)?Object.keys(t).reduce((a,u)=>e[u]?(a[u]=ht(e[u],t[u],r),a):(a[u]=t[u],a),{}):t}function Xn(e,{title:t,icon:r}){(0,R.dispatch)(P).addBlockCollection(e,t,r)}function Zn(e){let t=(0,R.select)(P).getBlockType(e);if(!t){(0,q.default)('Block "'+e+'" is not registered.');return}return(0,R.dispatch)(P).removeBlockTypes(e),t}function Qn(e){(0,R.dispatch)(P).setFreeformFallbackBlockName(e)}function ee(){return(0,R.select)(P).getFreeformFallbackBlockName()}function fr(){return(0,R.select)(P).getGroupingBlockName()}function Jn(e){(0,R.dispatch)(P).setUnregisteredFallbackBlockName(e)}function me(){return(0,R.select)(P).getUnregisteredFallbackBlockName()}function ea(e){(0,R.dispatch)(P).setDefaultBlockName(e)}function ra(e){(0,R.dispatch)(P).setGroupingBlockName(e)}function pr(){return(0,R.select)(P).getDefaultBlockName()}function M(e){return(0,R.select)(P)?.getBlockType(e)}function Ue(){return(0,R.select)(P).getBlockTypes()}function ta(e,t,r){return(0,R.select)(P).getBlockSupport(e,t,r)}function se(e,t,r){return(0,R.select)(P).hasBlockSupport(e,t,r)}function na(e){return e?.name==="core/block"}function aa(e){return e?.name==="core/template-part"}var ua=e=>(0,R.select)(P).getChildBlockNames(e),oa=e=>(0,R.select)(P).hasChildBlocks(e),ia=e=>(0,R.select)(P).hasChildBlocksWithInserterSupport(e),sa=(e,t)=>{(0,R.dispatch)(P).addBlockStyles(e,t)},da=(e,t)=>{(0,R.dispatch)(P).removeBlockStyles(e,t)},ca=(e,t)=>(0,R.select)(P).getBlockVariations(e,t),la=(e,t)=>{typeof t.name!="string"&&(0,q.default)("Variation names must be unique strings."),(0,R.dispatch)(P).addBlockVariations(e,t)},fa=(e,t)=>{(0,R.dispatch)(P).removeBlockVariations(e,t)},pa=e=>{let{name:t,label:r,usesContext:a,getValues:u,setValues:s,canUserEditValue:c,getFieldsList:h}=e,_=ue((0,R.select)(P)).getBlockBindingsSource(t),b=["label","usesContext"];for(let E in _)if(!b.includes(E)&&_[E]){(0,q.default)('Block bindings source "'+t+'" is already registered.');return}if(!t){(0,q.default)("Block bindings source must contain a name.");return}if(typeof t!="string"){(0,q.default)("Block bindings source name must be a string.");return}if(/[A-Z]+/.test(t)){(0,q.default)("Block bindings source name must not contain uppercase characters.");return}if(!/^[a-z0-9/-]+$/.test(t)){(0,q.default)("Block bindings source name must contain only valid characters: lowercase characters, hyphens, or digits. Example: my-plugin/my-custom-source.");return}if(!/^[a-z0-9-]+\/[a-z0-9-]+$/.test(t)){(0,q.default)("Block bindings source name must contain a namespace and valid characters. Example: my-plugin/my-custom-source.");return}if(!r&&!_?.label){(0,q.default)("Block bindings source must contain a label.");return}if(r&&typeof r!="string"){(0,q.default)("Block bindings source label must be a string.");return}if(r&&_?.label&&r!==_?.label&&(0,q.default)('Block bindings "'+t+'" source label was overridden.'),a&&!Array.isArray(a)){(0,q.default)("Block bindings source usesContext must be an array.");return}if(u&&typeof u!="function"){(0,q.default)("Block bindings source getValues must be a function.");return}if(s&&typeof s!="function"){(0,q.default)("Block bindings source setValues must be a function.");return}if(c&&typeof c!="function"){(0,q.default)("Block bindings source canUserEditValue must be a function.");return}if(h&&typeof h!="function"){(0,q.default)("Block bindings source getFieldsList must be a function.");return}return ue((0,R.dispatch)(P)).addBlockBindingsSource(e)};function ma(e){if(!gt(e)){(0,q.default)('Block bindings source "'+e+'" is not registered.');return}ue((0,R.dispatch)(P)).removeBlockBindingsSource(e)}function gt(e){return ue((0,R.select)(P)).getBlockBindingsSource(e)}function ha(){return ue((0,R.select)(P)).getAllBlockBindingsSources()}On([Dn,Mn]);var ga=["#191e23","#f8f9f9"];function _t(e,t){let r=M(e.name)?.attributes??{},a=t?Object.entries(r).filter(([s,c])=>t==="content"&&s==="metadata"?Object.keys(e.attributes[s]?.bindings??{}).length>0:c.role===t||c.__experimentalRole===t):[];return(a.length?a:Object.entries(r)).every(([s,c])=>{let h=e.attributes[s];return c.hasOwnProperty("default")?h===c.default:c.type==="rich-text"?!h?.length:h===void 0})}function hr(e,t){return e.name===pr()&&_t(e,t)}function $e(e){return!!e&&(typeof e=="string"||(0,mr.isValidElement)(e)||typeof e=="function"||e instanceof mr.Component)}function gr(e){if(e=e||cr,$e(e))return{src:e};if("background"in e){let t=ae(e.background),r=u=>t.contrast(u),a=Math.max(...ga.map(r));return{...e,foreground:e.foreground?e.foreground:ga.find(u=>r(u)===a),shadowColor:t.alpha(.3).toRgbString()}}return e}function de(e){return typeof e=="string"?M(e):e}function yt(e,t,r="visual"){let{__experimentalLabel:a,title:u}=e,s=a&&a(t,{context:r});return s?s.toPlainText?s.toPlainText():(0,ba.__unstableStripHTML)(s):u}function _a(e,t,r,a="vertical"){let u=e?.title,s=e?yt(e,t,"accessibility"):"",c=r!==void 0,h=s&&s!==u;return c&&a==="vertical"?h?(0,W.sprintf)((0,W.__)("%1$s Block. Row %2$d. %3$s"),u,r,s):(0,W.sprintf)((0,W.__)("%1$s Block. Row %2$d"),u,r):c&&a==="horizontal"?h?(0,W.sprintf)((0,W.__)("%1$s Block. Column %2$d. %3$s"),u,r,s):(0,W.sprintf)((0,W.__)("%1$s Block. Column %2$d"),u,r):h?(0,W.sprintf)((0,W.__)("%1$s Block. %2$s"),u,s):(0,W.sprintf)((0,W.__)("%s Block"),u)}function wt(e){if(e.default!==void 0)return e.default;if(e.type==="rich-text")return new Fe.RichTextData}function kt(e){return M(e)!==void 0}function Ge(e,t){let r=M(e);if(r===void 0)throw new Error(`Block type '${e}' is not registered.`);return Object.entries(r.attributes).reduce((a,[u,s])=>{let c=t[u];if(c!==void 0)s.type==="rich-text"?c instanceof Fe.RichTextData?a[u]=c:typeof c=="string"&&(a[u]=Fe.RichTextData.fromHTMLString(c)):s.type==="string"&&c instanceof Fe.RichTextData?a[u]=c.toHTMLString():a[u]=c;else{let h=wt(s);h!==void 0&&(a[u]=h)}return["node","children"].indexOf(s.source)!==-1&&(typeof a[u]=="string"?a[u]=[a[u]]:Array.isArray(a[u])||(a[u]=[])),a},{})}function vt(e,t){let r=M(e)?.attributes;if(!r)return[];let a=Object.keys(r);return t?a.filter(u=>{let s=r[u];return s?.role===t?!0:s?.__experimentalRole===t?((0,bt.default)("__experimentalRole attribute",{since:"6.7",version:"6.8",alternative:"role attribute",hint:`Check the block.json of the ${e} block.`}),!0):!1}):a}var ya=(...e)=>((0,bt.default)("__experimentalGetBlockAttributesNamesByRole",{since:"6.7",version:"6.8",alternative:"getBlockAttributesNamesByRole"}),vt(...e));function wa(e){let t=M(e),r=t?.attributes;return t?.supports?.contentRole?!0:r?!!Object.keys(r)?.some(u=>{let s=r[u];return s?.role==="content"||s?.__experimentalRole==="content"}):!1}function ce(e,t){return Object.fromEntries(Object.entries(e).filter(([r])=>!t.includes(r)))}var ri=[{slug:"text",title:(0,ye.__)("Text")},{slug:"media",title:(0,ye.__)("Media")},{slug:"design",title:(0,ye.__)("Design")},{slug:"widgets",title:(0,ye.__)("Widgets")},{slug:"theme",title:(0,ye.__)("Theme")},{slug:"embed",title:(0,ye.__)("Embeds")},{slug:"reusable",title:(0,ye.__)("Reusable blocks")}];function Et(e){return e.reduce((t,r)=>({...t,[r.name]:r}),{})}function br(e){return e.reduce((t,r)=>(t.some(a=>a.name===r.name)||t.push(r),t),[])}function ti(e={},t){switch(t.type){case"ADD_BOOTSTRAPPED_BLOCK_TYPE":let{name:r,blockType:a}=t;if(e[r])return e;let s=Object.fromEntries(Object.entries(a).filter(([,c])=>c!=null).map(([c,h])=>[kn(c),h]));return s.name=r,{...e,[r]:s};case"REMOVE_BLOCK_TYPES":return ce(e,t.names)}return e}function ni(e={},t){switch(t.type){case"ADD_UNPROCESSED_BLOCK_TYPE":return{...e,[t.name]:t.blockType};case"REMOVE_BLOCK_TYPES":return ce(e,t.names)}return e}function ai(e={},t){switch(t.type){case"ADD_BLOCK_TYPES":return{...e,...Et(t.blockTypes)};case"REMOVE_BLOCK_TYPES":return ce(e,t.names)}return e}function ui(e={},t){switch(t.type){case"ADD_BLOCK_TYPES":return{...e,...Object.fromEntries(Object.entries(Et(t.blockTypes)).map(([a,u])=>[a,br([...(u.styles??[]).map(s=>({...s,source:"block"})),...(e[u.name]??[]).filter(({source:s})=>s!=="block")])]))};case"ADD_BLOCK_STYLES":let r={};return t.blockNames.forEach(a=>{r[a]=br([...e[a]??[],...t.styles])}),{...e,...r};case"REMOVE_BLOCK_STYLES":return{...e,[t.blockName]:(e[t.blockName]??[]).filter(a=>t.styleNames.indexOf(a.name)===-1)}}return e}function oi(e={},t){switch(t.type){case"ADD_BLOCK_TYPES":return{...e,...Object.fromEntries(Object.entries(Et(t.blockTypes)).map(([r,a])=>[r,br([...(a.variations??[]).map(u=>({...u,source:"block"})),...(e[a.name]??[]).filter(({source:u})=>u!=="block")])]))};case"ADD_BLOCK_VARIATIONS":return{...e,[t.blockName]:br([...e[t.blockName]??[],...t.variations])};case"REMOVE_BLOCK_VARIATIONS":return{...e,[t.blockName]:(e[t.blockName]??[]).filter(r=>t.variationNames.indexOf(r.name)===-1)}}return e}function _r(e){return(t=null,r)=>{switch(r.type){case"REMOVE_BLOCK_TYPES":return r.names.indexOf(t)!==-1?null:t;case e:return r.name||null}return t}}var ii=_r("SET_DEFAULT_BLOCK_NAME"),si=_r("SET_FREEFORM_FALLBACK_BLOCK_NAME"),di=_r("SET_UNREGISTERED_FALLBACK_BLOCK_NAME"),ci=_r("SET_GROUPING_BLOCK_NAME");function li(e=ri,t){switch(t.type){case"SET_CATEGORIES":let r=new Map;return(t.categories||[]).forEach(a=>{r.set(a.slug,a)}),[...r.values()];case"UPDATE_CATEGORY":{if(!t.category||!Object.keys(t.category).length)return e;if(e.find(({slug:u})=>u===t.slug))return e.map(u=>u.slug===t.slug?{...u,...t.category}:u)}}return e}function fi(e={},t){switch(t.type){case"ADD_BLOCK_COLLECTION":return{...e,[t.namespace]:{title:t.title,icon:t.icon}};case"REMOVE_BLOCK_COLLECTION":return ce(e,t.namespace)}return e}function pi(e=[],t=[]){let r=Array.from(new Set(e.concat(t)));return r.length>0?r:void 0}function mi(e={},t){switch(t.type){case"ADD_BLOCK_BINDINGS_SOURCE":return{...e,[t.name]:{label:t.label||e[t.name]?.label,usesContext:pi(e[t.name]?.usesContext,t.usesContext),getValues:t.getValues,setValues:t.setValues,canUserEditValue:t.setValues&&t.canUserEditValue,getFieldsList:t.getFieldsList}};case"REMOVE_BLOCK_BINDINGS_SOURCE":return ce(e,t.name)}return e}var va=(0,ka.combineReducers)({bootstrappedBlockTypes:ti,unprocessedBlockTypes:ni,blockTypes:ai,blockStyles:ui,blockVariations:oi,defaultBlockName:ii,freeformFallbackBlockName:si,unregisteredFallbackBlockName:di,groupingBlockName:ci,categories:li,collections:fi,blockBindingsSources:mi});var Nt={};Ie(Nt,{__experimentalHasContentRoleAttribute:()=>qi,getActiveBlockVariation:()=>Ai,getBlockStyles:()=>Bi,getBlockSupport:()=>ja,getBlockType:()=>Me,getBlockTypes:()=>Ma,getBlockVariations:()=>At,getCategories:()=>Ni,getChildBlockNames:()=>St,getCollections:()=>Li,getDefaultBlockName:()=>Pi,getDefaultBlockVariation:()=>Si,getFreeformFallbackBlockName:()=>Ri,getGroupingBlockName:()=>Di,getUnregisteredFallbackBlockName:()=>Oi,hasBlockSupport:()=>za,hasChildBlocks:()=>ji,hasChildBlocksWithInserterSupport:()=>zi,isMatchingSearchTerm:()=>Mi});var Pa=B(Ba(),1),wr=B(Be(),1),Ra=B(xe(),1),Oa=B(J(),1);var Ae=(e,t,r)=>{let a=Array.isArray(t)?t:t.split("."),u=e;return a.forEach(s=>{u=u?.[s]}),u??r};function Aa(e){return typeof e=="object"&&e.constructor===Object&&e!==null}function Tt(e,t){return Aa(e)&&Aa(t)?Object.entries(t).every(([r,a])=>Tt(e?.[r],a)):e===t}var Bt={};Ie(Bt,{getAllBlockBindingsSources:()=>Ei,getBlockBindingsSource:()=>Ti,getBlockBindingsSourceFieldsList:()=>Ci,getBootstrappedBlockType:()=>ki,getSupportedStyles:()=>wi,getUnprocessedBlockTypes:()=>vi,hasContentRoleAttribute:()=>Ct});var Ke=B(Be(),1),Na=B(J(),1);var yi=["background","backgroundColor","color","linkColor","captionColor","buttonColor","headingColor","fontFamily","fontSize","fontStyle","fontWeight","lineHeight","padding","contentSize","wideSize","blockGap","textAlign","textDecoration","textIndent","textTransform","letterSpacing"];function Sa(e,t,r){return e.filter(a=>!(a==="fontSize"&&r==="heading"||a==="textDecoration"&&!t&&r!=="link"||a==="textTransform"&&!t&&!(["heading","h1","h2","h3","h4","h5","h6"].includes(r)||r==="button"||r==="caption"||r==="text")||a==="letterSpacing"&&!t&&!(["heading","h1","h2","h3","h4","h5","h6"].includes(r)||r==="button"||r==="caption"||r==="text")||a==="textIndent"&&!t||a==="textColumns"&&!t))}var wi=(0,Ke.createSelector)((e,t,r)=>{if(!t)return Sa(yi,t,r);let a=Me(e,t);if(!a)return[];let u=[];return a?.supports?.spacing?.blockGap&&u.push("blockGap"),a?.supports?.shadow&&u.push("shadow"),Object.keys(pe).forEach(s=>{if(pe[s].support){if(pe[s].requiresOptOut&&pe[s].support[0]in a.supports&&Ae(a.supports,pe[s].support)!==!1){u.push(s);return}Ae(a.supports,pe[s].support,!1)&&u.push(s)}}),Sa(u,t,r)},(e,t)=>[e.blockTypes[t]]);function ki(e,t){return e.bootstrappedBlockTypes[t]}function vi(e){return e.unprocessedBlockTypes}function Ei(e){return e.blockBindingsSources}function Ti(e,t){return e.blockBindingsSources[t]}var Ci=(0,Ke.createRegistrySelector)(e=>(0,Ke.createSelector)((t,r,a)=>{if(!r.getFieldsList)return[];let u={};if(r?.usesContext?.length)for(let s of r.usesContext)u[s]=a[s];return r.getFieldsList({select:e,context:u})},(t,r,a)=>[r.getFieldsList,r.usesContext,a])),Ct=(e,t)=>{let r=Me(e,t);return r?Object.values(r.attributes).some(({role:a,__experimentalRole:u})=>a==="content"?!0:u==="content"?((0,Na.default)("__experimentalRole attribute",{since:"6.7",version:"6.8",alternative:"role attribute",hint:`Check the block.json of the ${t} block.`}),!0):!1):!1};var Da=(e,t)=>typeof t=="string"?Me(e,t):t,Ma=(0,wr.createSelector)(e=>Object.values(e.blockTypes),e=>[e.blockTypes]);function Me(e,t){return e.blockTypes[t]}function Bi(e,t){return e.blockStyles[t]}var At=(0,wr.createSelector)((e,t,r)=>{let a=e.blockVariations[t];return!a||!r?a:a.filter(u=>(u.scope||["block","inserter"]).includes(r))},(e,t)=>[e.blockVariations[t]]);function Ai(e,t,r,a){let u=At(e,t,a);if(!u)return u;let s=Me(e,t),c=Object.keys(s?.attributes||{}),h,_=0;for(let b of u)if(Array.isArray(b.isActive)){let E=b.isActive.filter(j=>{let I=j.split(".")[0];return c.includes(I)}),L=E.length;if(L===0)continue;E.every(j=>{let I=Ae(b.attributes,j);if(I===void 0)return!1;let G=Ae(r,j);return G instanceof Ra.RichTextData&&(G=G.toHTMLString()),Tt(G,I)})&&L>_&&(h=b,_=L)}else if(b.isActive?.(r,b.attributes))return h||b;return!h&&["block","transform"].includes(a)&&(h=u.find(b=>b?.isDefault&&!Object.hasOwn(b,"isActive"))),h}function Si(e,t,r){let a=At(e,t,r);return[...a].reverse().find(({isDefault:s})=>!!s)||a[0]}function Ni(e){return e.categories}function Li(e){return e.collections}function Pi(e){return e.defaultBlockName}function Ri(e){return e.freeformFallbackBlockName}function Oi(e){return e.unregisteredFallbackBlockName}function Di(e){return e.groupingBlockName}var St=(0,wr.createSelector)((e,t)=>Ma(e).filter(r=>r.parent?.includes(t)).map(({name:r})=>r),e=>[e.blockTypes]),ja=(e,t,r,a)=>{let u=Da(e,t);return u?.supports?Ae(u.supports,r,a):a};function za(e,t,r,a){return!!ja(e,t,r,a)}function La(e){return(0,Pa.default)(e??"").toLowerCase().trim()}function Mi(e,t,r=""){let a=Da(e,t),u=La(r),s=c=>La(c).includes(u);return s(a.title)||a.keywords?.some(s)||s(a.category)||typeof a.description=="string"&&s(a.description)}var ji=(e,t)=>St(e,t).length>0,zi=(e,t)=>St(e,t).some(r=>za(e,r,"inserter",!0)),qi=(...e)=>((0,Oa.default)("__experimentalHasContentRoleAttribute",{since:"6.7",version:"6.8",hint:"This is a private selector."}),Ct(...e));var Dt={};Ie(Dt,{__experimentalReapplyBlockFilters:()=>Ui,addBlockCollection:()=>rs,addBlockStyles:()=>$i,addBlockTypes:()=>Hi,addBlockVariations:()=>Ki,reapplyBlockTypeFilters:()=>Wa,removeBlockCollection:()=>ts,removeBlockStyles:()=>Gi,removeBlockTypes:()=>Fi,removeBlockVariations:()=>Wi,setCategories:()=>Ji,setDefaultBlockName:()=>Yi,setFreeformFallbackBlockName:()=>Xi,setGroupingBlockName:()=>Qi,setUnregisteredFallbackBlockName:()=>Zi,updateCategory:()=>es});var Ka=B(J(),1);function qa(e){return Object.prototype.toString.call(e)==="[object Object]"}function Ia(e){var t,r;return qa(e)===!1?!1:(t=e.constructor,t===void 0?!0:(r=t.prototype,!(qa(r)===!1||r.hasOwnProperty("isPrototypeOf")===!1)))}var Ga=B(Ua(),1),Rt=B(J(),1),Ot=B(We(),1),te=B(pt(),1);var $a={common:"text",formatting:"text",layout:"design"};function xi(e=[],t=[]){let r=[...e];return t.forEach(a=>{let u=r.findIndex(s=>s.name===a.name);u!==-1?r[u]={...r[u],...a}:r.push(a)}),r}var Pr=(e,t)=>({select:r})=>{let a=r.getBootstrappedBlockType(e),u={apiVersion:1,name:e,icon:cr,keywords:[],attributes:{},providesContext:{},usesContext:[],selectors:{},supports:{},styles:[],blockHooks:{},save:()=>null,...a,...t,variations:xi(Array.isArray(a?.variations)?a.variations:[],Array.isArray(t?.variations)?t.variations:[])};(!u.attributes||typeof u.attributes!="object")&&((0,te.default)('The block "'+e+'" is registering attributes as `null` or `undefined`. Use an empty object (`attributes: {}`) or exclude the `attributes` key.'),u.attributes={});let s=(0,Ot.applyFilters)("blocks.registerBlockType",u,e,null);if(s.apiVersion<=2&&(0,Rt.default)("Block with API version 2 or lower",{since:"6.9",hint:`The block "${e}" is registered with API version ${s.apiVersion}. This means that the post editor may work as a non-iframe editor. Since all editors are planned to work as iframes in the future, set the \`apiVersion\` field to 3 and test the block inside the iframe editor.`}),s.description&&typeof s.description!="string"&&(0,Rt.default)("Declaring non-string block descriptions",{since:"6.2"}),s.deprecated&&(s.deprecated=s.deprecated.map(c=>Object.fromEntries(Object.entries((0,Ot.applyFilters)("blocks.registerBlockType",{...ce(u,He),...c},u.name,c)).filter(([h])=>He.includes(h))))),!Ia(s)){(0,te.default)("Block settings must be a valid object.");return}if(typeof s.save!="function"){(0,te.default)('The "save" property must be a valid function.');return}if("edit"in s&&!(0,Ga.isValidElementType)(s.edit)){(0,te.default)('The "edit" property must be a valid component.');return}if($a.hasOwnProperty(s.category)&&(s.category=$a[s.category]),"category"in s&&!r.getCategories().some(({slug:c})=>c===s.category)&&((0,te.default)('The block "'+e+'" is registered with an invalid category "'+s.category+'".'),delete s.category),!("title"in s)||s.title===""){(0,te.default)('The block "'+e+'" must have a title.');return}if(typeof s.title!="string"){(0,te.default)("Block titles must be strings.");return}if(s.icon=gr(s.icon),!$e(s.icon.src)){(0,te.default)("The icon passed is invalid. The icon should be a string, an element, a function, or an object following the specification");return}if((typeof s?.parent=="string"||s?.parent instanceof String)&&(s.parent=[s.parent],(0,te.default)("Parent must be undefined or an array of strings (block types), but it is a string.")),!Array.isArray(s?.parent)&&s?.parent!==void 0){(0,te.default)("Parent must be undefined or an array of block types, but it is ",s.parent);return}if(s?.parent?.length===1&&e===s.parent[0]){(0,te.default)('Block "'+e+'" cannot be a parent of itself. Please remove the block name from the parent list.');return}return s};function Hi(e){return{type:"ADD_BLOCK_TYPES",blockTypes:Array.isArray(e)?e:[e]}}function Wa(){return({dispatch:e,select:t})=>{let r=[];for(let[a,u]of Object.entries(t.getUnprocessedBlockTypes())){let s=e(Pr(a,u));s&&r.push(s)}r.length&&e.addBlockTypes(r)}}function Ui(){return(0,Ka.default)('wp.data.dispatch( "core/blocks" ).__experimentalReapplyBlockFilters',{since:"6.4",alternative:"reapplyBlockFilters"}),Wa()}function Fi(e){return{type:"REMOVE_BLOCK_TYPES",names:Array.isArray(e)?e:[e]}}function $i(e,t){return{type:"ADD_BLOCK_STYLES",styles:Array.isArray(t)?t:[t],blockNames:Array.isArray(e)?e:[e]}}function Gi(e,t){return{type:"REMOVE_BLOCK_STYLES",styleNames:Array.isArray(t)?t:[t],blockName:e}}function Ki(e,t){return{type:"ADD_BLOCK_VARIATIONS",variations:Array.isArray(t)?t:[t],blockName:e}}function Wi(e,t){return{type:"REMOVE_BLOCK_VARIATIONS",variationNames:Array.isArray(t)?t:[t],blockName:e}}function Yi(e){return{type:"SET_DEFAULT_BLOCK_NAME",name:e}}function Xi(e){return{type:"SET_FREEFORM_FALLBACK_BLOCK_NAME",name:e}}function Zi(e){return{type:"SET_UNREGISTERED_FALLBACK_BLOCK_NAME",name:e}}function Qi(e){return{type:"SET_GROUPING_BLOCK_NAME",name:e}}function Ji(e){return{type:"SET_CATEGORIES",categories:e}}function es(e,t){return{type:"UPDATE_CATEGORY",slug:e,category:t}}function rs(e,t,r){return{type:"ADD_BLOCK_COLLECTION",namespace:e,title:t,icon:r}}function ts(e){return{type:"REMOVE_BLOCK_COLLECTION",namespace:e}}var Mt={};Ie(Mt,{addBlockBindingsSource:()=>us,addBootstrappedBlockType:()=>ns,addUnprocessedBlockType:()=>as,removeBlockBindingsSource:()=>os});function ns(e,t){return{type:"ADD_BOOTSTRAPPED_BLOCK_TYPE",name:e,blockType:t}}function as(e,t){return({dispatch:r})=>{r({type:"ADD_UNPROCESSED_BLOCK_TYPE",name:e,blockType:t});let a=r(Pr(e,t));a&&r.addBlockTypes(a)}}function us(e){return{type:"ADD_BLOCK_BINDINGS_SOURCE",name:e.name,label:e.label,usesContext:e.usesContext,getValues:e.getValues,setValues:e.setValues,canUserEditValue:e.canUserEditValue,getFieldsList:e.getFieldsList}}function os(e){return{type:"REMOVE_BLOCK_BINDINGS_SOURCE",name:e}}var Ya="core/blocks";var P=(0,Rr.createReduxStore)(Ya,{reducer:va,selectors:Nt,actions:Dt});(0,Rr.register)(P);ue(P).registerPrivateSelectors(Bt);ue(P).registerPrivateActions(Mt);var Or,is=new Uint8Array(16);function jt(){if(!Or&&(Or=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!Or))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return Or(is)}var H=[];for(let e=0;e<256;++e)H.push((e+256).toString(16).slice(1));function Xa(e,t=0){return H[e[t+0]]+H[e[t+1]]+H[e[t+2]]+H[e[t+3]]+"-"+H[e[t+4]]+H[e[t+5]]+"-"+H[e[t+6]]+H[e[t+7]]+"-"+H[e[t+8]]+H[e[t+9]]+"-"+H[e[t+10]]+H[e[t+11]]+H[e[t+12]]+H[e[t+13]]+H[e[t+14]]+H[e[t+15]]}var ss=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),zt={randomUUID:ss};function ds(e,t,r){if(zt.randomUUID&&!t&&!e)return zt.randomUUID();e=e||{};let a=e.random||(e.rng||jt)();if(a[6]=a[6]&15|64,a[8]=a[8]&63|128,t){r=r||0;for(let u=0;u<16;++u)t[r+u]=a[u];return t}return Xa(a)}var Ye=ds;var Dr=B(We(),1);function U(e,t={},r=[]){if(!kt(e))return U("core/missing",{originalName:e,originalContent:"",originalUndelimitedContent:""});let a=Ge(e,t);return{clientId:Ye(),name:e,isValid:!0,attributes:a,innerBlocks:r}}function It(e=[]){return e.map(t=>{let r=Array.isArray(t)?t:[t.name,t.attributes,t.innerBlocks],[a,u,s=[]]=r;return U(a,u,It(s))})}function Vt(e,t={},r){let{name:a}=e;if(!kt(a))return U("core/missing",{originalName:a,originalContent:"",originalUndelimitedContent:""});let u=Ye(),s=Ge(a,{...e.attributes,...t});return{...e,clientId:u,attributes:s,innerBlocks:r||e.innerBlocks.map(c=>Vt(c))}}function xt(e,t={},r){let a=Ye();return{...e,clientId:a,attributes:{...e.attributes,...t},innerBlocks:r||e.innerBlocks.map(u=>xt(u))}}var Qa=(e,t,r)=>{if(!r.length)return!1;let a=r.length>1,u=r[0].name;if(!(je(e)||!a||e.isMultiBlock)||!je(e)&&!r.every(b=>b.name===u)||!(e.type==="block"))return!1;let h=r[0];return!(!(t!=="from"||e.blocks.indexOf(h.name)!==-1||je(e))||!a&&t==="from"&&Za(h.name)&&Za(e.blockName)||!qt(e,r))},cs=e=>e.length?Ue().filter(a=>{let u=oe("from",a.name);return!!he(u,s=>Qa(s,"from",e))}):[],ls=e=>{if(!e.length)return[];let t=e[0],r=M(t.name);return(r?oe("to",r.name):[]).filter(c=>c&&Qa(c,"to",e)).map(c=>c.blocks).flat().map(M)},je=e=>e&&e.type==="block"&&Array.isArray(e.blocks)&&e.blocks.includes("*"),Za=e=>e===fr();function Ja(e){if(!e.length)return[];let t=cs(e),r=ls(e);return[...new Set([...t,...r])]}function he(e,t){let r=(0,Dr.createHooks)();for(let a=0;a<e.length;a++){let u=e[a];t(u)&&r.addFilter("transform","transform/"+a.toString(),s=>s||u,u.priority)}return r.applyFilters("transform",null)}function oe(e,t){if(t===void 0)return Ue().map(({name:h})=>oe(e,h)).flat();let r=de(t),{name:a,transforms:u}=r||{};if(!u||!Array.isArray(u[e]))return[];let s=u.supportedMobileTransforms&&Array.isArray(u.supportedMobileTransforms);return(s?u[e].filter(h=>h.type==="raw"||h.type==="prefix"?!0:!h.blocks||!h.blocks.length?!1:je(h)?!0:h.blocks.every(_=>u.supportedMobileTransforms.includes(_))):u[e]).map(h=>({...h,blockName:a,usingMobileTransformations:s}))}function qt(e,t){if(typeof e.isMatch!="function")return!0;let r=t[0],a=e.isMultiBlock?t.map(s=>s.attributes):r.attributes,u=e.isMultiBlock?t:r;return e.isMatch(a,u)}function eu(e,t){let r=Array.isArray(e)?e:[e],a=r.length>1,u=r[0],s=u.name,c=oe("from",t),h=oe("to",s),_=he(h,N=>N.type==="block"&&(je(N)||N.blocks.indexOf(t)!==-1)&&(!a||N.isMultiBlock)&&qt(N,r))||he(c,N=>N.type==="block"&&(je(N)||N.blocks.indexOf(s)!==-1)&&(!a||N.isMultiBlock)&&qt(N,r));if(!_)return null;let b;return _.isMultiBlock?"__experimentalConvert"in _?b=_.__experimentalConvert(r):b=_.transform(r.map(N=>N.attributes),r.map(N=>N.innerBlocks)):"__experimentalConvert"in _?b=_.__experimentalConvert(u):b=_.transform(u.attributes,u.innerBlocks),b===null||typeof b!="object"||(b=Array.isArray(b)?b:[b],b.some(N=>!M(N.name)))||!b.some(N=>N.name===t)?null:b.map((N,j,I)=>(0,Dr.applyFilters)("blocks.switchToBlockType.transformedBlock",N,e,j,I))}var Ht=(e,t)=>U(e,t.attributes,(t.innerBlocks??[]).map(r=>Ht(r.name,r)));var $u=B(tu(),1),Gu=B(Ut(),1);var ve=B(De(),1),ke=B(We(),1),su=B(uu(),1),du=B(Ut(),1),cu=B(J(),1);function we(e,t={}){let{isCommentDelimited:r=!0}=t,{blockName:a,attrs:u={},innerBlocks:s=[],innerContent:c=[]}=e,h=0,_=c.map(b=>b!==null?b:we(s[h++],t)).join(`
`).replace(/\n+/g,`
`).trim();return r?Ft(a,u,_):_}var lu=B(iu(),1);function fu(e){let t="wp-block-"+e.replace(/\//,"-").replace(/^core-/,"");return(0,ke.applyFilters)("blocks.getBlockDefaultClassName",t,e)}function pu(e){let t="editor-block-list-item-"+e.replace(/\//,"-").replace(/^core-/,"");return(0,ke.applyFilters)("blocks.getBlockMenuDefaultClassName",t,e)}var $t={},mu={};function Gt(e={}){let{blockType:t,attributes:r}=$t;return Gt.skipFilters?e:(0,ke.applyFilters)("blocks.getSaveContent.extraProps",{...e},t,r)}function hu(e={}){let{innerBlocks:t}=mu;if(!Array.isArray(t))return{...e,children:t};let r=Mr(t,{isInnerBlocks:!0});return{...e,children:(0,lu.jsx)(ve.RawHTML,{children:r})}}function Kt(e,t,r=[]){let a=de(e);if(!a?.save)return null;let{save:u}=a;if(u.prototype instanceof ve.Component){let c=new u({attributes:t});u=c.render.bind(c)}$t.blockType=a,$t.attributes=t,mu.innerBlocks=r;let s=u({attributes:t,innerBlocks:r});if(s!==null&&typeof s=="object"&&(0,ke.hasFilter)("blocks.getSaveContent.extraProps")&&!(a.apiVersion>1)){let c=(0,ke.applyFilters)("blocks.getSaveContent.extraProps",{...s.props},a,t);(0,su.isShallowEqual)(c,s.props)||(s=(0,ve.cloneElement)(s,c))}return(0,ke.applyFilters)("blocks.getSaveElement",s,a,t)}function ge(e,t,r){let a=de(e);return(0,ve.renderToString)(Kt(a,t,r))}function fs(e,t){return Object.entries(e.attributes??{}).reduce((r,[a,u])=>{let s=t[a];return s===void 0||u.source!==void 0||u.role==="local"?r:u.__experimentalRole==="local"?((0,cu.default)("__experimentalRole attribute",{since:"6.7",version:"6.8",alternative:"role attribute",hint:`Check the block.json of the ${e?.name} block.`}),r):("default"in u&&JSON.stringify(u.default)===JSON.stringify(s)||(r[a]=s),r)},{})}function ps(e){return JSON.stringify(e).replaceAll("\\\\","\\u005c").replaceAll("--","\\u002d\\u002d").replaceAll("<","\\u003c").replaceAll(">","\\u003e").replaceAll("&","\\u0026").replaceAll('\\"',"\\u0022")}function Xe(e){let t=e.originalContent;if(e.isValid||e.innerBlocks.length)try{t=ge(e.name,e.attributes,e.innerBlocks)}catch{}return t}function Ft(e,t,r){let a=t&&Object.entries(t).length?ps(t)+" ":"",u=e?.startsWith("core/")?e.slice(5):e;return r?`<!-- wp:${u} ${a}-->
`+r+`
<!-- /wp:${u} -->`:`<!-- wp:${u} ${a}/-->`}function ms(e,{isInnerBlocks:t=!1}={}){if(!e.isValid&&e.__unstableBlockSource)return we(e.__unstableBlockSource);let r=e.name,a=Xe(e);if(r===me()||!t&&r===ee())return a;let u=M(r);if(!u)return a;let s=fs(u,e.attributes);return Ft(r,s,a)}var gu=(()=>{let e=new WeakMap;return t=>{let r=e.get(t);if(r!==void 0)return r;let a=t;a.length===1&&hr(a[0])&&(a=[]);let u=Mr(a);return a.length===1&&a[0].name===ee()&&a[0].name==="core/freeform"&&(u=(0,du.removep)(u)),e.set(t,u),u}})();function Mr(e,t){return(Array.isArray(e)?e:[e]).map(a=>ms(a,t)).join(`

`)}var hs=/^#[xX]([A-Fa-f0-9]+)$/,gs=/^#([0-9]+)$/,bs=/^([A-Za-z0-9]+)$/,dl=(function(){function e(t){this.named=t}return e.prototype.parse=function(t){if(t){var r=t.match(hs);if(r)return String.fromCharCode(parseInt(r[1],16));if(r=t.match(gs),r)return String.fromCharCode(parseInt(r[1],10));if(r=t.match(bs),r)return this.named[r[1]]}},e})(),_s=/[\t\n\f ]/,ys=/[A-Za-z]/,ws=/\r\n?/g;function Se(e){return _s.test(e)}function bu(e){return ys.test(e)}function ks(e){return e.replace(ws,`
...
%s`,u.name,u,s,e.originalContent),[c,a.getItems()]}function Pu(e,t,r){(0,Su.default)("isValidBlockContent introduces opportunity for data loss",{since:"12.6",plugin:"Gutenberg",alternative:"validateBlock"});let a=de(e),u={name:a.name,attributes:t,innerBlocks:[],originalContent:r},[s]=be(u,a);return s}function jr(e,t){let r={...t};if(e==="core/cover-image"&&(e="core/cover"),(e==="core/text"||e==="core/cover-text")&&(e="core/paragraph"),e&&e.indexOf("core/social-link-")===0&&(r.service=e.substring(17),e="core/social-link"),e&&e.indexOf("core-embed/")===0){let a=e.substring(11),u={speaker:"speaker-deck",polldaddy:"crowdsignal"};r.providerNameSlug=a in u?u[a]:a,["amazon-kindle","wordpress"].includes(a)||(r.responsive=!0),e="core/embed"}if(e==="core/post-comment-author"&&(e="core/comment-author-name"),e==="core/post-comment-content"&&(e="core/comment-content"),e==="core/post-comment-date"&&(e="core/comment-date"),e==="core/comments-query-loop"){e="core/comments";let{className:a=""}=r;a.includes("wp-block-comments-query-loop")||(r.className=["wp-block-comments-query-loop",a].join(" "))}if(e==="core/post-comments"&&(e="core/comments",r.legacy=!0),t.layout?.type==="grid"&&typeof t.layout?.columnCount=="string"&&(r.layout={...r.layout,columnCount:parseInt(t.layout.columnCount,10)}),typeof t.style?.layout?.columnSpan=="string"){let a=parseInt(t.style.layout.columnSpan,10);r.style={...r.style,layout:{...r.style.layout,columnSpan:isNaN(a)?void 0:a}}}if(typeof t.style?.layout?.rowSpan=="string"){let a=parseInt(t.style.layout.rowSpan,10);r.style={...r.style,layout:{...r.style.layout,rowSpan:isNaN(a)?void 0:a}}}return[e,r]}function Yt(e,t){for(var r=t.split("."),a;a=r.shift();){if(!(a in e))return;e=e[a]}return e}var Fs=(function(){var e;return function(){return e||(e=document.implementation.createHTMLDocument("")),e}})();function zr(e,t){if(t){if(typeof e=="string"){var r=Fs();r.body.innerHTML=e,e=r.body}if(typeof t=="function")return t(e);if(Object===t.constructor)return Object.keys(t).reduce(function(a,u){return a[u]=zr(e,t[u]),a},{})}}function Qe(e,t){return arguments.length===1&&(t=e,e=void 0),function(r){var a=r;if(e&&(a=r.querySelector(e)),a)return Yt(a,t)}}function Xt(e,t){return arguments.length===1&&(t=e,e=void 0),function(r){var a=Qe(e,"attributes")(r);if(a&&a.hasOwnProperty(t))return a[t].value}}function Zt(e){return Qe(e,"textContent")}function Qt(e,t){return function(r){var a=r.querySelectorAll(e);return[].map.call(a,function(u){return zr(u,t)})}}function Ru(e,t){var r=0,a,u;t=t||{};function s(){var c=a,h=arguments.length,_,b;e:for(;c;){if(c.args.length!==arguments.length){c=c.next;continue}for(b=0;b<h;b++)if(c.args[b]!==arguments[b]){c=c.next;continue e}return c!==a&&(c===u&&(u=c.prev),c.prev.next=c.next,c.next&&(c.next.prev=c.prev),c.next=a,c.prev=null,a.prev=c,a=c),c.val}for(_=new Array(h),b=0;b<h;b++)_[b]=arguments[b];return c={args:_,val:e.apply(null,_)},a?(a.prev=c,c.next=a):u=c,r===t.maxSize?(u=u.prev,u.next=null):r++,a=c,c.val}return s.clear=function(){a=null,u=null,r=0},s}var qu=B(We(),1),Iu=B(xe(),1);var en=B(xe(),1);var Je=B(J(),1);var Ou=B(De(),1),ze=B(J(),1);function $s(e){return(0,ze.default)("wp.blocks.children.getChildrenArray",{since:"6.1",version:"6.3"}),e}function Gs(...e){(0,ze.default)("wp.blocks.children.concat",{since:"6.1",version:"6.3",alternative:"wp.richText.concat"});let t=[];for(let r=0;r<e.length;r++){let a=Array.isArray(e[r])?e[r]:[e[r]];for(let u=0;u<a.length;u++){let s=a[u];typeof s=="string"&&typeof t[t.length-1]=="string"?t[t.length-1]+=s:t.push(s)}}return t}function qr(e){(0,ze.default)("wp.blocks.children.fromDOM",{since:"6.1",version:"6.3",alternative:"wp.richText.create"});let t=[];for(let r=0;r<e.length;r++)try{t.push(Vr(e[r]))}catch{}return t}function Jt(e){(0,ze.default)("wp.blocks.children.toHTML",{since:"6.1",version:"6.3",alternative:"wp.richText.toHTMLString"});let t=e;return(0,Ou.renderToString)(t)}function Ir(e){return(0,ze.default)("wp.blocks.children.matcher",{since:"6.1",version:"6.3",alternative:"html source"}),t=>{let r=t;return e&&(r=t.querySelector(e)),r?qr(r.childNodes):[]}}var Du={concat:Gs,getChildrenArray:$s,fromDOM:qr,toHTML:Jt,matcher:Ir};function Ys(e,t){return(0,Je.default)("wp.blocks.node.isNodeOfType",{since:"6.1",version:"6.3"}),e&&e.type===t}function Xs(e){let t={};for(let r=0;r<e.length;r++){let{name:a,value:u}=e[r];t[a]=u}return t}function Vr(e){if((0,Je.default)("wp.blocks.node.fromDOM",{since:"6.1",version:"6.3",alternative:"wp.richText.create"}),e.nodeType===e.TEXT_NODE)return e.nodeValue;if(e.nodeType!==e.ELEMENT_NODE)throw new TypeError("A block node can only be created from a node of type text or element.");return{type:e.nodeName.toLowerCase(),props:{...Xs(e.attributes),children:qr(e.childNodes)}}}function Zs(e){return(0,Je.default)("wp.blocks.node.toHTML",{since:"6.1",version:"6.3",alternative:"wp.richText.toHTMLString"}),Jt([e])}function xr(e){return(0,Je.default)("wp.blocks.node.matcher",{since:"6.1",version:"6.3",alternative:"html source"}),t=>{let r=t;e&&(r=t.querySelector(e));try{return Vr(r)}catch{return null}}}var Mu={isNodeOfType:Ys,fromDOM:Vr,toHTML:Zs,matcher:xr};function ju(e,t){return r=>{let a=r;if(e&&(a=r.querySelector(e)),!a)return"";if(t){let u="",s=a.children.length;for(let c=0;c<s;c++){let h=a.children[c];h.nodeName.toLowerCase()===t&&(u+=h.outerHTML)}return u}return a.innerHTML}}var zu=(e,t)=>r=>{let a=e?r.querySelector(e):r;return a?en.RichTextData.fromHTMLElement(a,{preserveWhiteSpace:t}):en.RichTextData.empty()};var Qs=e=>t=>e(t)!==void 0;function Js(e,t){switch(t){case"rich-text":return e instanceof Iu.RichTextData;case"string":return typeof e=="string";case"boolean":return typeof e=="boolean";case"object":return!!e&&e.constructor===Object;case"null":return e===null;case"array":return Array.isArray(e);case"integer":case"number":return typeof e=="number"}return!0}function ed(e,t){return t.some(r=>Js(e,r))}function rd(e,t,r,a,u){let s;switch(t.source){case void 0:s=a?a[e]:void 0;break;case"raw":s=u;break;case"attribute":case"property":case"html":case"text":case"rich-text":case"children":case"node":case"query":case"tag":s=Le(r,t);break}return(!td(s,t.type)||!nd(s,t.enum))&&(s=void 0),s===void 0&&(s=wt(t)),s}function td(e,t){return t===void 0||ed(e,Array.isArray(t)?t:[t])}function nd(e,t){return!Array.isArray(t)||t.includes(e)}var Vu=Ru(e=>{switch(e.source){case"attribute":{let r=Xt(e.selector,e.attribute);return e.type==="boolean"&&(r=Qs(r)),r}case"html":return ju(e.selector,e.multiline);case"text":return Zt(e.selector);case"rich-text":return zu(e.selector,e.__unstablePreserveWhiteSpace);case"children":return Ir(e.selector);case"node":return xr(e.selector);case"query":let t=Object.fromEntries(Object.entries(e.query).map(([r,a])=>[r,Vu(a)]));return Qt(e.selector,t);case"tag":{let r=Qe(e.selector,"nodeName");return a=>r(a)?.toLowerCase()}default:console.error(`Unknown source type "${e.source}"`)}});function xu(e){return zr(e,t=>t)}function Le(e,t){return Vu(t)(xu(e))}function ie(e,t,r={}){let a=xu(t),u=de(e),s=Object.fromEntries(Object.entries(u.attributes??{}).map(([c,h])=>[c,rd(c,h,a,r,t)]));return(0,qu.applyFilters)("blocks.getBlockAttributes",s,u,t,r)}var ad={type:"string",source:"attribute",selector:"[data-custom-class-name] > *",attribute:"class"};function Hu(e){let t=Le(`<div data-custom-class-name>${e}</div>`,ad);return t?t.trim().split(/\s+/):[]}function Uu(e,t,r){if(!se(t,"customClassName",!0))return e;let a={...e},{className:u,...s}=a,c=ge(t,s),h=Hu(c),b=Hu(r).filter(E=>!h.includes(E));return b.length?a.className=b.join(" "):c&&delete a.className,a}function ud(e,t,r){return Le(`<div ${t}>${e}</div>`,r)}function rn(e,t,r,a,u,s){if(!se(t,a,!1))return e;let c={...e},h=ud(r,u,s);return h&&(c[a]=h),c}var od={type:"string",source:"attribute",selector:"[data-aria-label] > *",attribute:"aria-label"},id={type:"string",source:"attribute",selector:"[data-anchor] > *",attribute:"id"};function Pe(e,t){let{attributes:r,originalContent:a}=e,u=r;return u=Uu(r,t,a),u=rn(u,t,a,"ariaLabel","data-aria-label",od),u=rn(u,t,a,"anchor","data-anchor",id),{...e,attributes:u}}function sd(){return!1}function Fu(e,t,r){let a=t.attrs,{deprecated:u}=r;if(!u||!u.length)return e;for(let s=0;s<u.length;s++){let{isEligible:c=sd}=u[s];if(e.isValid&&!c(a,e.innerBlocks,{blockNode:t,block:e}))continue;let h=Object.assign(ce(r,He),u[s]),_={...e,attributes:ie(h,e.originalContent,a)},[b]=be(_,h);if(b||(_=Pe(_,h),[b]=be(_,h)),!b)continue;let E=_.innerBlocks,L=_.attributes,{migrate:N}=h;if(N){let j=N(L,e.innerBlocks);Array.isArray(j)||(j=[j]),[L=a,E=e.innerBlocks]=j}e={...e,attributes:L,innerBlocks:E,isValid:!0,validationIssues:[]}}return e}function dd(e){let[t,r]=jr(e.blockName,e.attrs);return{...e,blockName:t,attrs:r}}function cd(e,t){let r=ee(),a=e.blockName||ee(),u=e.attrs||{},s=e.innerBlocks||[],c=e.innerHTML.trim();return a===r&&a==="core/freeform"&&!t?.__unstableSkipAutop&&(c=(0,Gu.autop)(c).trim()),{...e,blockName:a,attrs:u,innerHTML:c,innerBlocks:s}}function ld(e){let t=me()||ee(),r=we(e,{isCommentDelimited:!1}),a=we(e,{isCommentDelimited:!0});return{blockName:t,attrs:{originalName:e.blockName,originalContent:a,originalUndelimitedContent:r},innerHTML:e.blockName?a:e.innerHTML,innerBlocks:e.innerBlocks,innerContent:e.innerContent}}function fd(e,t){let[r]=be(e,t);if(r)return{...e,isValid:r,validationIssues:[]};let a=Pe(e,t),[u,s]=be(a,t);return{...a,isValid:u,validationIssues:s}}function Hr(e,t){let r=cd(e,t);r=dd(r);let a=M(r.blockName);a||(r=ld(r),a=M(r.blockName));let u=r.blockName===ee()||r.blockName===me();if(!a||!r.innerHTML&&u)return;let s=r.innerBlocks.map(E=>Hr(E,t)).filter(E=>!!E),c=U(r.blockName,ie(a,r.innerHTML,r.attrs),s);c.originalContent=r.innerHTML;let h=fd(c,a),{validationIssues:_}=h,b=Fu(h,r,a);return b.isValid||(b.__unstableBlockSource=e),!h.isValid&&b.isValid&&!t?.__unstableSkipMigrationLogs?(console.groupCollapsed("Updated Block: %s",a.name),console.info(`Block successfully updated for \`%s\` (%o).
...
%s`,a.name,a,ge(a,b.attributes),b.originalContent),console.groupEnd()):!h.isValid&&!b.isValid&&_.forEach(({log:E,args:L})=>E(...L)),b}function Ee(e,t){return(0,$u.parse)(e).reduce((r,a)=>{let u=Hr(a,t);return u&&r.push(u),r},[])}var Bo=B(J(),1),Ao=B(Z(),1);var Ku=B(De(),1);function Ur(){return oe("from").filter(({type:e})=>e==="raw").map(e=>e.isMatch?e:{...e,isMatch:t=>e.selector&&t.matches(e.selector)})}function Fr(e,t){let r=document.implementation.createHTMLDocument("");return r.body.innerHTML=e,Array.from(r.body.children).flatMap(a=>{let u=he(Ur(),({isMatch:h})=>h(a));if(!u)return Ku.Platform.isNative?Ee(`<!-- wp:html -->${a.outerHTML}<!-- /wp:html -->`):U("core/html",ie("core/html",a.outerHTML));let{transform:s,blockName:c}=u;if(s){let h=s(a,t);return a.hasAttribute("class")&&(h.attributes.className=a.getAttribute("class")),h}return U(c,ie(c,a.outerHTML))})}var er=B(Z(),1);function Te(e,t={}){let r=document.implementation.createHTMLDocument(""),a=document.implementation.createHTMLDocument(""),u=r.body,s=a.body;for(u.innerHTML=e;u.firstChild;){let c=u.firstChild;c.nodeType===c.TEXT_NODE?(0,er.isEmpty)(c)?u.removeChild(c):((!s.lastChild||s.lastChild.nodeName!=="P")&&s.appendChild(a.createElement("P")),s.lastChild.appendChild(c)):c.nodeType===c.ELEMENT_NODE?c.nodeName==="BR"?(c.nextSibling&&c.nextSibling.nodeName==="BR"&&(s.appendChild(a.createElement("P")),u.removeChild(c.nextSibling)),s.lastChild&&s.lastChild.nodeName==="P"&&s.lastChild.hasChildNodes()?s.lastChild.appendChild(c):u.removeChild(c)):c.nodeName==="P"?(0,er.isEmpty)(c)&&!t.raw?u.removeChild(c):s.appendChild(c):(0,er.isPhrasingContent)(c)?((!s.lastChild||s.lastChild.nodeName!=="P")&&s.appendChild(a.createElement("P")),s.lastChild.appendChild(c)):s.appendChild(c):u.removeChild(c)}return s.innerHTML}var rr=B(Z(),1);function $r(e,t){if(e.nodeType!==e.COMMENT_NODE||e.nodeValue!=="nextpage"&&e.nodeValue.indexOf("more")!==0)return;let r=pd(e,t);if(!e.parentNode||e.parentNode.nodeName!=="P")(0,rr.replace)(e,r);else{let a=Array.from(e.parentNode.childNodes),u=a.indexOf(e),s=e.parentNode.parentNode||t.body,c=(h,_)=>(h||(h=t.createElement("p")),h.appendChild(_),h);[a.slice(0,u).reduce(c,null),r,a.slice(u+1).reduce(c,null)].forEach(h=>h&&s.insertBefore(h,e.parentNode)),(0,rr.remove)(e.parentNode)}}function pd(e,t){if(e.nodeValue==="nextpage")return hd(t);let r=e.nodeValue.slice(4).trim(),a=e,u=!1;for(;a=a.nextSibling;)if(a.nodeType===a.COMMENT_NODE&&a.nodeValue==="noteaser"){u=!0,(0,rr.remove)(a);break}return md(r,u,t)}function md(e,t,r){let a=r.createElement("wp-block");return a.dataset.block="core/more",e&&(a.dataset.customText=e),t&&(a.dataset.noTeaser=""),a}function hd(e){let t=e.createElement("wp-block");return t.dataset.block="core/nextpage",t}var Yu=B(Z(),1);function Wu(e){return e.nodeName==="OL"||e.nodeName==="UL"}function gd(e){return Array.from(e.childNodes).map(({nodeValue:t=""})=>t).join("")}function Gr(e){if(!Wu(e))return;let t=e,r=e.previousElementSibling;if(r&&r.nodeName===e.nodeName&&t.children.length===1){for(;t.firstChild;)r.appendChild(t.firstChild);t.parentNode.removeChild(t)}let a=e.parentNode;if(a&&a.nodeName==="LI"&&a.children.length===1&&!/\S/.test(gd(a))){let u=a,s=u.previousElementSibling,c=u.parentNode;s&&(s.appendChild(t),c.removeChild(u))}if(a&&Wu(a)){let u=e.previousElementSibling;u?u.appendChild(e):(0,Yu.unwrap)(e)}}function Kr(e){return t=>{t.nodeName==="BLOCKQUOTE"&&(t.innerHTML=Te(t.innerHTML,e))}}var Xu=B(Z(),1);function bd(e,t){let r=e.nodeName.toLowerCase();return r==="figcaption"||(0,Xu.isTextContent)(e)?!1:r in(t?.figure?.children??{})}function _d(e,t){return e.nodeName.toLowerCase()in(t?.figure?.children?.a?.children??{})}function tn(e,t=e){let r=e.ownerDocument.createElement("figure");t.parentNode.insertBefore(r,t),r.appendChild(e)}function Wr(e,t,r){if(!bd(e,r))return;let a=e,u=e.parentNode;_d(e,r)&&u.nodeName==="A"&&u.childNodes.length===1&&(a=e.parentNode);let s=a.closest("p,div");s?e.classList?(e.classList.contains("alignright")||e.classList.contains("alignleft")||e.classList.contains("aligncenter")||!s.textContent.trim())&&tn(a,s):tn(a,s):tn(a)}var nr=B(Qu(),1);var Ju=e=>Array.isArray(e)?e:[e],eo=/(\n|<p>)\s*$/,ro=/^\s*(\n|<\/p>)/;function tr(e,t=0,r=[]){let a=oe("from"),u=he(a,b=>r.indexOf(b.blockName)===-1&&b.type==="shortcode"&&Ju(b.tag).some(E=>(0,nr.regexp)(E).test(e)));if(!u)return[e];let c=Ju(u.tag).find(b=>(0,nr.regexp)(b).test(e)),h,_=t;if(h=(0,nr.next)(c,e,t)){t=h.index+h.content.length;let b=e.substr(0,h.index),E=e.substr(t);if(!h.shortcode.content?.includes("<")&&!(eo.test(b)&&ro.test(E)))return tr(e,t);if(u.isMatch&&!u.isMatch(h.shortcode.attrs))return tr(e,_,[...r,u.blockName]);let L=[];if(typeof u.transform=="function")L=[].concat(u.transform(h.shortcode.attrs,h)),L=L.map(N=>(N.originalContent=h.shortcode.content,Pe(N,M(N.name))));else{let N=Object.fromEntries(Object.entries(u.attributes).filter(([,Ce])=>Ce.shortcode).map(([Ce,or])=>[Ce,or.shortcode(h.shortcode.attrs,h)])),j=M(u.blockName);if(!j)return[e];let I={...j,attributes:u.attributes},G=U(u.blockName,ie(I,h.shortcode.content,N));G.originalContent=h.shortcode.content,G=Pe(G,I),L=[G]}return[...tr(b.replace(eo,"")),...L,...tr(E.replace(ro,""))]}return[e]}var Yr=tr;var ar=B(Z(),1);function yd(e,t){let a={phrasingContentSchema:(0,ar.getPhrasingContentSchema)(t),isPaste:t==="paste"},u=e.map(({isMatch:_,blockName:b,schema:E})=>{let L=se(b,"anchor");return E=typeof E=="function"?E(a):E,!L&&!_?E:E?Object.fromEntries(Object.entries(E).map(([N,j])=>{let I=j.attributes||[];return L&&(I=[...I,"id"]),[N,{...j,attributes:I,isMatch:_||void 0}]})):{}});function s(_,b,E){switch(E){case"children":return _==="*"||b==="*"?"*":{..._,...b};case"attributes":case"require":return[..._||[],...b||[]];case"isMatch":return!_||!b?void 0:(...L)=>_(...L)||b(...L)}}function c(_,b){for(let E in b)_[E]=_[E]?s(_[E],b[E],E):{...b[E]};return _}function h(_,b){for(let E in b)_[E]=_[E]?c(_[E],b[E]):{...b[E]};return _}return u.reduce(h,{})}function Xr(e){return yd(Ur(),e)}function to(e){if(!/<(?!br[ />])/i.test(e))return!0;let t=document.implementation.createHTMLDocument("");if(t.body.innerHTML=e,t.body.children.length!==1)return!1;let r=t.body.children.item(0),a=r.getElementsByTagName("*");for(let u=0;u<a.length;u++)if(a.item(u).tagName!=="BR")return!1;return r.tagName==="SPAN"}function no(e,t,r,a){Array.from(e).forEach(u=>{no(u.childNodes,t,r,a),t.forEach(s=>{r.contains(u)&&s(u,r,a)})})}function le(e,t=[],r){let a=document.implementation.createHTMLDocument("");return a.body.innerHTML=e,no(a.body.childNodes,t,a,r),a.body.innerHTML}function qe(e,t){let r=e[`${t}Sibling`];if(r&&(0,ar.isPhrasingContent)(r))return r;let{parentNode:a}=e;if(!(!a||!(0,ar.isPhrasingContent)(a)))return qe(a,t)}var Re=B(Z(),1);var ao=B(Z(),1);function nn(e){e.nodeType===e.COMMENT_NODE&&(0,ao.remove)(e)}var uo=B(Z(),1);function wd(e,t){if((0,uo.isTextContent)(e))return!0;if(!t)return!1;let r=e.nodeName.toLowerCase();return[["ul","li","ol"],["h1","h2","h3","h4","h5","h6"]].some(u=>[r,t].filter(s=>!u.includes(s)).length===0)}function oo(e,t){return e.every(r=>wd(r,t)&&oo(Array.from(r.children),t))}function kd(e){return e.nodeName==="BR"&&e.previousSibling&&e.previousSibling.nodeName==="BR"}function io(e,t){let r=document.implementation.createHTMLDocument("");r.body.innerHTML=e;let a=Array.from(r.body.children);return!a.some(kd)&&oo(a,t)}var _e=B(Z(),1);function an(e,t){if(e.nodeName==="SPAN"&&e.style){let{fontWeight:r,fontStyle:a,textDecorationLine:u,textDecoration:s,verticalAlign:c}=e.style;(r==="bold"||r==="700")&&(0,_e.wrap)(t.createElement("strong"),e),a==="italic"&&(0,_e.wrap)(t.createElement("em"),e),(u==="line-through"||s.includes("line-through"))&&(0,_e.wrap)(t.createElement("s"),e),c==="super"?(0,_e.wrap)(t.createElement("sup"),e):c==="sub"&&(0,_e.wrap)(t.createElement("sub"),e)}else e.nodeName==="B"?e=(0,_e.replaceTag)(e,"strong"):e.nodeName==="I"?e=(0,_e.replaceTag)(e,"em"):e.nodeName==="A"&&(e.target&&e.target.toLowerCase()==="_blank"?e.rel="noreferrer noopener":(e.removeAttribute("target"),e.removeAttribute("rel")),e.name&&!e.id&&(e.id=e.name),e.id&&!e.ownerDocument.querySelector(`[href="#${e.id}"]`)&&e.removeAttribute("id"))}function un(e){e.nodeName!=="SCRIPT"&&e.nodeName!=="NOSCRIPT"&&e.nodeName!=="TEMPLATE"&&e.nodeName!=="STYLE"||e.parentNode.removeChild(e)}function Zr(e){if(e.nodeType!==e.ELEMENT_NODE)return;let t=e.getAttribute("style");if(!t||!t.includes("mso-list"))return;t.split(";").reduce((a,u)=>{let[s,c]=u.split(":");return s&&c&&(a[s.trim().toLowerCase()]=c.trim().toLowerCase()),a},{})["mso-list"]==="ignore"&&e.remove()}function on(e){return e.nodeName==="OL"||e.nodeName==="UL"}function so(e,t){if(e.nodeName!=="P")return;let r=e.getAttribute("style");if(!r||!r.includes("mso-list"))return;let a=e.previousElementSibling;if(!a||!on(a)){let E=e.textContent.trim().slice(0,1),L=/[1iIaA]/.test(E),N=t.createElement(L?"ol":"ul");L&&N.setAttribute("type",E),e.parentNode.insertBefore(N,e)}let u=e.previousElementSibling,s=u.nodeName,c=t.createElement("li"),h=u;c.innerHTML=le(e.innerHTML,[Zr]);let _=/mso-list\s*:[^;]+level([0-9]+)/i.exec(r),b=_&&parseInt(_[1],10)-1||0;for(;b--;)h=h.lastChild||h,on(h)&&(h=h.lastChild||h);on(h)||(h=h.appendChild(t.createElement(s))),h.appendChild(c),e.parentNode.removeChild(e)}var fo=B(lo(),1);function po(e){if(e.nodeName==="IMG"){if(e.src.indexOf("file:")===0&&(e.src=""),e.src.indexOf("data:")===0){let[t,r]=e.src.split(","),[a]=t.slice(5).split(";");if(!r||!a){e.src="";return}let u;try{u=atob(r)}catch{e.src="";return}let s=new Uint8Array(u.length);for(let _=0;_<s.length;_++)s[_]=u.charCodeAt(_);let c=a.replace("/","."),h=new window.File([s],c,{type:a});e.src=(0,fo.createBlobURL)(h)}(e.height===1||e.width===1)&&e.parentNode.removeChild(e)}}function mo(e){e.nodeName==="DIV"&&(e.innerHTML=Te(e.innerHTML))}var bo=B(go(),1),vd=new bo.default.Converter({noHeaderId:!0,tables:!0,literalMidWordUnderscores:!0,omitExtraWLInCodeBlocks:!0,simpleLineBreaks:!0,strikethrough:!0});function Ed(e){return e.replace(/((?:^|\n)```)([^\n`]+)(```(?:$|\n))/,(t,r,a,u)=>`${r}
${a}
${u}`)}function Td(e){return e.replace(/(^|\n)•( +)/g,"$1*$2")}function _o(e){return vd.makeHtml(Ed(Td(e)))}function yo(e){if(e.nodeName==="IFRAME"){let t=e.ownerDocument.createTextNode(e.src);e.parentNode.replaceChild(t,e)}}var wo=B(Z(),1);function sn(e){!e.id||e.id.indexOf("docs-internal-guid-")!==0||(e.tagName==="B"?(0,wo.unwrap)(e):e.removeAttribute("id"))}function Cd(e){return e===" "||e==="\r"||e===`
`||e==="	"}function dn(e){if(e.nodeType!==e.TEXT_NODE)return;let t=e;for(;t=t.parentNode;)if(t.nodeType===t.ELEMENT_NODE&&t.nodeName==="PRE")return;let r=e.data.replace(/[ \r\n\t]+/g," ");if(r[0]===" "){let a=qe(e,"previous");(!a||a.nodeName==="BR"||a.textContent.slice(-1)===" ")&&(r=r.slice(1))}if(r[r.length-1]===" "){let a=qe(e,"next");(!a||a.nodeName==="BR"||a.nodeType===a.TEXT_NODE&&Cd(a.textContent[0]))&&(r=r.slice(0,-1))}r?e.data=r:e.parentNode.removeChild(e)}function cn(e){e.nodeName==="BR"&&(qe(e,"next")||e.parentNode.removeChild(e))}function ko(e){e.nodeName==="P"&&(e.hasChildNodes()||e.parentNode.removeChild(e))}function vo(e){if(e.nodeName!=="SPAN"||e.getAttribute("data-stringify-type")!=="paragraph-break")return;let{parentNode:t}=e;t.insertBefore(e.ownerDocument.createElement("br"),e),t.insertBefore(e.ownerDocument.createElement("br"),e),t.removeChild(e)}function Eo(e){let t=/[\p{L}\s]+/gu,r;for(;r=t.exec(e);){if(e[r.index-1]==="{")continue;let u=r[0];if(e[r.index-1]==="\\"&&(u=u.replace(/^[a-zA-Z]+/,"")),!(u.length<6))return!1}return!!(/\\[a-zA-Z]+\s*\{/g.test(e)||[u=>u.includes("^")&&!u.startsWith("^"),u=>["=","+","-","/","*"].some(s=>u.includes(s)),u=>/\\[a-zA-Z]+/g.test(u)].filter(u=>u(e)).length>=2)}function To(e){if(e.nodeType===e.ELEMENT_NODE&&e.tagName==="P"&&e.getAttribute("role")==="heading"&&e.hasAttribute("aria-level")){let t=parseInt(e.getAttribute("aria-level"),10);if(t>=1&&t<=6){let r=`H${t}`,a=e.ownerDocument.createElement(r);for(Array.from(e.attributes).forEach(u=>{u.name!=="role"&&u.name!=="aria-level"&&a.setAttribute(u.name,u.value)});e.firstChild;)a.appendChild(e.firstChild);e.parentNode.replaceChild(a,e)}}}var Jr=(...e)=>window?.console?.log?.(...e);function Co(e){return e=le(e,[un,sn,Zr,an,nn]),e=(0,Re.removeInvalidHTML)(e,(0,Re.getPhrasingContentSchema)("paste"),{inline:!0}),e=le(e,[dn,cn]),Jr(`Processed inline HTML:
...
`,t),e=e.replace(/<meta[^>]+>/g,""),e=e.replace(/^\s*<html[^>]*>\s*<body[^>]*>(?:\s*<!--\s*StartFragment\s*-->)?/i,""),e=e.replace(/(?:<!--\s*EndFragment\s*-->\s*)?<\/body>\s*<\/html>\s*$/i,""),r!=="INLINE"){let E=e||t;if(E.indexOf("<!-- wp:")!==-1){let L=Ee(E);if(!(L.length===1&&L[0].name==="core/freeform"))return L}}String.prototype.normalize&&(e=e.normalize()),e=le(e,[vo]);let u=t&&(!e||to(e));if(u&&Eo(t))return[U("core/math",{latex:t})];u&&(e=t,/^\s+$/.test(t)||(e=_o(e)));let s=Yr(e),c=s.length>1;if(u&&!c&&r==="AUTO"&&t.indexOf(`
`)===-1&&t.indexOf("<p>")!==0&&e.indexOf("<p>")===0&&(r="INLINE"),r==="INLINE"||r==="AUTO"&&!c&&io(e,a))return Co(e);let h=(0,Re.getPhrasingContentSchema)("paste"),_=Xr("paste"),b=s.map(E=>{if(typeof E!="string")return E;let L=[sn,so,un,Gr,po,an,$r,nn,yo,Wr,Kr(),mo,To],N={..._,...h};return E=le(E,L,_),E=(0,Re.removeInvalidHTML)(E,N),E=Te(E),E=le(E,[dn,cn,ko],_),Jr(`Processed HTML piece:
...
`)===-1)return(0,Re.removeInvalidHTML)(Xe(b[0]),h).replace(E,"")}return b}function So(e){return(0,Bo.default)("wp.blocks.getPhrasingContentSchema",{since:"5.6",alternative:"wp.dom.getPhrasingContentSchema"}),(0,Ao.getPhrasingContentSchema)(e)}function ln({HTML:e=""}){if(e.indexOf("<!-- wp:")!==-1){let a=Ee(e);if(!(a.length===1&&a[0].name==="core/freeform"))return a}let t=Yr(e),r=Xr();return t.map(a=>{if(typeof a!="string")return a;let u=[Gr,$r,Wr,Kr({raw:!0})];return a=le(a,u,r),a=Te(a,{raw:!0}),Fr(a,ln)}).flat().filter(Boolean)}var ur=B(Be(),1);function No(){return(0,ur.select)(P).getCategories()}function Lo(e){(0,ur.dispatch)(P).setCategories(e)}function Po(e,t){(0,ur.dispatch)(P).updateCategory(e,t)}var Ro=B(De(),1);function fn(e=[],t=[]){return e.length===t.length&&t.every(([r,,a],u)=>{let s=e[u];return r===s.name&&fn(s.innerBlocks,a)})}var Bd=e=>e?.source==="html",Ad=e=>e?.source==="query";function Oo(e,t){return t?Object.fromEntries(Object.entries(t).map(([r,a])=>[r,Sd(e[r],a)])):{}}function Sd(e,t){return Bd(e)&&Array.isArray(t)?(0,Ro.renderToString)(t):Ad(e)&&t?t.map(r=>Oo(e.query,r)):t}function rt(e=[],t){return t?t.map(([r,a,u],s)=>{let c=e[s];if(c&&c.name===r){let L=rt(c.innerBlocks,u);return{...c,innerBlocks:L}}let h=M(r),_=Oo(h?.attributes??{},a),[b,E]=jr(r,_);return U(b,E,rt([],u))}):e}var Nd=Symbol("fields"),Ld=Symbol("form"),Do={};Gn(Do,{isContentBlock:wa,fieldsKey:Nd,formKey:Ld,parseRawBlock:Hr});var Mo=B(J(),1);function Pd(e){return(0,Mo.default)("wp.blocks.withBlockContentContext",{since:"6.1"}),e}return Ho(Rd);})();
