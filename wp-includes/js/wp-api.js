	...
	wp.api.utils.addMixinsAndHelpers = function( model, modelClassName, loadingObjects ) {
		...
		var hasDate = false,
			...
			TimeStampedMixin = {
				 ...
				 *
				 * @param {Date}   date   A JavaScript date object. Retraceur expects dates in UTC.
				 ...
				 *
				 * Retraceur returns 'date' and 'date_modified' in the timezone of the server as well as
