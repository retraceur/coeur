...
class WP_HTML_Tag_Processor {
	 ...
	 * @since WP 7.1.0 Recognizes processing instructions.
	 *
	 ...
	 * @since WP 7.1.0 Supports setting processing instruction data.
	 *
	...
	public function set_attribute( $name, $value ): bool {
		 ...
		 * in the Retraceur and plugin stack. Specifically the following
	 ...
	 *
	 * @since WP 6.5.0
	 * @since WP 7.1.0 Only applies to reserved and XML-specific target names;
