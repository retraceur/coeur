...
class WP_HTML_Processor extends WP_HTML_Tag_Processor {
	 ...
	 *
	 * @since WP 6.4.0
	 * @since WP 7.0.0 Increased from 100 to 10,000
	 *
	 * @var int
	 */
	 ...
	 *
	 * @since WP 6.4.0
	 * @since WP 6.6.0 Returns `static` instead of `self` so it can create subclass instances.
	 *
	 ...
	 *
	 * @since WP 6.4.0
	 * @since WP 6.6.0 Visits all tokens, including virtual ones.
	 *
	 ...
	 *
	 * @since WP 6.5.0 Added for internal support; do not use.
	 * @since WP 6.7.2 Refactored so subclasses may extend.
	 *
	 ...
	 *
	 * @since WP 6.6.0 Subclassed for HTML Processor.
	 *
	 ...
	 *
	 * @since WP 6.7.0
	 * @since WP 6.9.0 Converted from protected to public method.
	 *
	 ...
	 *
	 * @since WP 6.6.0 Subclassed for the HTML Processor.
	 *
	 ...
	 *
	 * @since WP 6.6.0 Subclassed for the HTML Processor.
	 * @since WP 7.1.0 Recognize processing instructions according to an HTML
	 ...
	 *
	 * @since WP 6.6.0 Subclassed for the HTML Processor.
	 * @since WP 6.9.0 Escapes all character references instead of trying to avoid double-escaping.
	 *
