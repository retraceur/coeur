...
class WP_HTML_Processor_State {
	 ...
	 * @since WP 6.7.0
	 *
	 * @deprecated WP 7.1.0 The "in select" insertion mode was removed from the standard.
	 * @ignore
	 *
	 * @see WP_HTML_Processor_State::$insertion_mode
	 *
	 ...
	 * @since WP 6.7.0
	 *
	 * @deprecated WP 7.1.0 The "in select in table" insertion mode was removed from the standard.
	 * @ignore
	 *
	 * @see WP_HTML_Processor_State::$insertion_mode
	 *
	 ...
	 *
	 * @since WP 6.4.0
	 * @deprecated WP 6.8.0 WP_HTML_Processor tracks the context_node internally.
	 *
	 * @var null
	 */
