 ...
 * @since WP 6.9.0 Now runs first at `wp_head` priority 4, with a fallback to priority 10. This helps ensure the discovery links appear within the first 150KB.
 */
...
function the_embed_site_title() {
	$site_title = sprintf(
		...
		esc_url( home_url() ),
		esc_url( get_site_icon_url( 32, includes_url( 'images/retraceur-80x80.png' ) ) ),
		esc_url( get_site_icon_url( 64, includes_url( 'images/retraceur-80x80.png' ) ) ),
