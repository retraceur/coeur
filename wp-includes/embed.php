...
function the_embed_site_title() {
	$site_title = sprintf(
		...
		esc_url( home_url() ),
		esc_url( get_site_icon_url( 32, includes_url( 'images/mv-logo-blue-white-red.png' ) ) ),
		esc_url( get_site_icon_url( 64, includes_url( 'images/mv-logo-blue-white-red.png' ) ) ),
