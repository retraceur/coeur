...
class WP_REST_Global_Styles_Controller extends WP_REST_Posts_Controller {
	 ...
	 * @since WP 7.0.0 Only restricts contents which risk prematurely closing the STYLE element,
	 ...
	 * @since WP 7.1.0 Rejects non-string values with a WP_Error instead of a fatal error.
	 *
