...
class WP_REST_Attachments_Controller extends WP_REST_Posts_Controller {
	 ...
	 *
	 * @since WP 4.7.0
	 * @since WP 6.9.0 Extends the `media_type` and `mime_type` request arguments to support array values.
	 *
	...
	protected function prepare_links( $post ) {
		...
		if ( ! empty( $post->post_parent ) ) {
			...
			if ( ! empty( $post ) ) {
				$links['https://retraceur.github.io/api/attached-to'] = array(
	 ...
	 *
	 * @since WP 4.7.0
	 * @since WP 6.6.0 Added the `$time` parameter.
	 *
