...
class WP_REST_Taxonomies_Controller extends WP_REST_Controller {
	 ...
	 *
	 * @since WP 4.7.0
	 * @since WP 5.9.0 Renamed `$taxonomy` to `$item` to match parent class for PHP 8 named parameter support.
	 *
	 ...
	 *
	 * @since WP 4.7.0
	 * @since WP 5.0.0 The `visibility` property was added.
	 * @since WP 5.9.0 The `rest_namespace` property was added.
	 *
