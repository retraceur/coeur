...
class WP_REST_Abilities_V1_List_Controller extends WP_REST_Controller {
	...
	/**
	 * WP-internal schema keywords to strip from REST responses.
	 *
	 * @since WP 7.0.0
	...
	/**
	 * Recursively removes WP-internal keywords from a schema.
	 *
	 * Ability schemas may include WP-internal properties like
	 ...
	 *
	 * @param array<string, mixed> $schema The schema array.
	 * @return array<string, mixed> The schema without WP-internal keywords.
	 */
