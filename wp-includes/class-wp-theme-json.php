...
class WP_Theme_JSON {
	 ...
	 * @since WP 6.9.0 Added `border.radiusSizes`.
	 * @var array
	 */
	 ...
	 * @since WP 7.1.0 Added `min-width` and `text-shadow`.
	 * @var array
	 */
	 ...
	 * @since WP 7.1.0 Added support for `background.gradient`,`dimensions.minWidth`,
	 ...
	 * @since WP 6.8.0 Added support for ':focus-visible'.
	 * @since WP 6.9.0 Added `textInput` and `select` elements.
	 * @var array
	 */
	 ...
	 *
	 * @since WP 6.1.0
	 * @since WP 7.0.0 Added support for `dimensions`.
	 * @var string[]
	 */
	 ...
	 *
	 * @since WP 5.8.0
	 * @since WP 7.0.0 Added type validation for boolean values.
	 *
	 ...
	 * @since WP 7.0.0 Deprecated 'base-layout-styles' type; added `base_layout_styles` option for classic themes.
	 *
	 ...
	 * @since WP 7.0.0 Made public for use in custom-css block support.
	 *
	 ...
	 * @since WP 7.0.0 Replaced `$types` parameter with `$options` array; base layout styles controlled via `base_layout_styles` option.
	 *
	 ...
	 *
	 * @since WP 5.8.0
	 * @since WP 7.1.0 Skip declarations whose value is not a plain string (booleans, arrays, objects, etc.).
	 *
	 ...
	 * @since WP 7.0.0 Added `$options` parameter to control alignment styles output for classic themes.
	 *
	 ...
	 *
	 * @since WP 6.8.0
	 * @since WP 7.1.0 Added the `$responsive_media_queries` parameter.
	 *
	 ...
	 *
	 * @since WP 5.9.0
	 * @since WP 7.1.0 Added the `$is_root` parameter.
	 *
	 ...
	 *
	 * @since WP 6.6.0
	 * @since WP 6.8.0 Added the `$blocks_metadata` parameter.
	 *
