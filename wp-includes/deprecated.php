 ...
 *
 * @since WP 6.2.0
 * @deprecated WP 6.7.0 Use {@see 'wp_get_global_stylesheet'} instead for top-level custom CSS, or {@see 'WP_Theme_JSON::get_styles_for_block'} for block-level custom CSS.
 *
 ...
 *
 * @since WP 0.71
 * @deprecated WP 7.0.0 Use wp_slash() instead.
 * @see wp_slash()
 *
 ...
 *
 * @since WP 5.7.0
 * @deprecated WP 7.0.0 Use wp_get_script_tag() or wp_get_inline_script_tag().
