...
class WP_Script_Modules {
	 ...
	 *
	 * @since WP 6.5.0
	 * @since WP 7.0.0 Script module dependencies ('module_dependencies') of classic scripts are now included.
	 *
	 ...
	 * Retraceur version. If $version is set to null, no version is added.
