...
/**
 * Checks whether the current site's URL where Retraceur is stored is using HTTPS.
 *
 * This checks the URL where Retraceur application files (e.g. wp-blog-header.php or the wp-admin/ folder)
 * are accessible.
 *
 * @since WP 5.7.0
 * @see site_url()
...
/**
 * Checks whether a given HTML string is likely an output from this Retraceur site.
 *
 * This function attempts to check for various common Retraceur patterns whether they are included in the HTML string.
...
function wp_is_local_html_output( $html ) {
	// Check if HTML includes the site's REST API link.
