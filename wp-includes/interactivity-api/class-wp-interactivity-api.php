...
final class WP_Interactivity_API {
	 ...
	 *
	 * @since WP 6.7.0
	 * @since WP 6.9.0 Serializes derived state props accessed during directive processing.
	 *
	 * @param array $data Data to filter.
	 ...
	 *
	 * @since WP 6.5.0
	 * @since WP 6.9.0 Adds support for client-side navigation in script modules.
	 */
	 ...
	 * @since WP 6.9.0 Recieve $entry as an argument instead of the directive value string.
	 *
...
HTML;
	 ...
	 *
	 * @since WP 6.5.0
	 * @since WP 6.9.0 Include the list path in the rendered `data-wp-each-child` directives.
	 *
	 * @param WP_Interactivity_API_Directives_Processor $p               The directives processor instance.
	 * @param string                                    $mode            Whether the processing is entering or exiting the tag.
