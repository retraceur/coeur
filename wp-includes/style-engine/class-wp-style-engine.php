 ...
 * @since WP 7.0.0 Added support for typography.textIndent.
 */
...
final class WP_Style_Engine {
	 ...
	 * @since WP 7.1.0 Extended `$css_declarations` parameter to accept `WP_Style_Engine_CSS_Declarations` object.
	 *
