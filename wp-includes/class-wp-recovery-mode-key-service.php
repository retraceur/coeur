...
final class WP_Recovery_Mode_Key_Service {
	 ...
	 *
	 * @since WP 5.2.0
	 * @since WP 6.8.0 The stored key is now hashed using wp_fast_hash() instead of phpass.
	 *
	 ...
	 *
	 * @since WP 5.2.0
	 * @since WP 6.8.0 Each key is now hashed using wp_fast_hash() instead of phpass.
	 ...
	 *
	 * @since WP 5.2.0
	 * @since WP 6.8.0 Each key should now be hashed using wp_fast_hash() instead of phpass.
	 *
	 * @param array $keys {
	 *     Associative array of token => data pairs, where the data is an associative
	 *     array of information about the key.
