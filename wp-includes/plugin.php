 ...
 *
 * Retraceur offers filter hooks to allow plugins to modify
 ...
 *
 * @since WP 0.71
 * @since WP 6.0.0 Formalized the existing and already documented `...$args` parameter
 ...
 *
 * @since WP 2.5.0
 * @since WP 6.9.0 Added the `$priority` parameter.
 *
 * @global WP_Hook[] $wp_filter Stores all of the filters and actions.
 *
 * @param string                      $hook_name The name of the filter hook.
 ...
 *
 * Actions are the hooks that the Retraceur core launches at specific points
 ...
 * @param string $version     The version of WP/Retraceur that deprecated the hook.
 ...
 *
 * @since WP 2.2.3
 * @since WP 5.3.0 Removed workarounds for spl_object_hash().
 *              `$hook_name` and `$priority` are no longer used,
 *              and no longer returns false, but can still return void for invalid callbacks.
 * @since WP 6.9.0 Returns explicit null if an invalid callback is supplied.
 * @since WP 7.1.0 Uses spl_object_id() instead of spl_object_hash() for performance.
 *
 * @access private
 *
