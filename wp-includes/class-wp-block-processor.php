...
class WP_Block_Processor {
	 ...
	 * Example:
	 *
	 *     'core/paragraph' === WP_Block_Processor::normalize_block_type( 'paragraph' );
	 *     'core/paragraph' === WP_Block_Processor::normalize_block_type( 'core/paragraph' );
	 *     'my/paragraph'   === WP_Block_Processor::normalize_block_type( 'my/paragraph' );
	 *
	 * @since WP 6.9.0
	 *
	 ...
	 * Example:
	 *
	 *     $processor = new WP_Block_Processor( '<!-- wp:image {"url": "https://retraceur.github.io/favicon.ico"} -->' );
	 *     $processor->next_delimiter();
	 *     $memory_hungry_and_slow_attributes = $processor->allocate_and_return_parsed_attributes();
	 *     $memory_hungry_and_slow_attributes === array( 'url' => 'https://retraceur.github.io/favicon.ico' );
	 *
	 *     $processor = new WP_Block_Processor( '<!-- /wp:image {"url": "https://retraceur.github.io/favicon.ico"} -->' );
	 *     $processor->next_delimiter();
