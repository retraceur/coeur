 ...
 *
 * @since WP 2.7.0
 * @since WP 4.2.0 Custom taxonomy class names were added.
 *
 ...
 *
 * @since WP 1.2.0
 * @since WP 5.1.0 Added the `aria_current` argument.
 *
 * @global int $page
 * @global int $numpages
 ...
 *                                      'menu_order', 'post_parent', 'ID', 'rand'. Default 'post_title'.
 ...
 *
 * @since WP 2.5.0
 * @since WP 4.4.0 The `$post` parameter can now accept either a post ID or `WP_Post` object.
 *
 * @param int|WP_Post  $post      Optional. Post ID or post object.
...
function wp_get_attachment_link( $post = 0, $size = 'thumbnail', $permalink = false, $icon = false, $text = false, $attr = '' ) {
	 ...
	 *
	 * @since WP 2.7.0
	 * @since WP 5.1.0 Added the `$attr` parameter.
	 *
...
function get_the_password_form( $post = 0 ) {
	 ...
	 *
	 * @since WP 2.7.0
	 * @since WP 5.8.0 Added the `$post` parameter.
	 * @since WP 6.8.0 Added the `$invalid_password` parameter.
	 *
