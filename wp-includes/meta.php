...
function add_metadata( $meta_type, $object_id, $meta_key, $meta_value, $unique = false ) {
	 ...
	 * (post, term, user, or any other type with an associated meta table).
...
function get_metadata_raw( $meta_type, $object_id, $meta_key = '', $single = false ) {
	 ...
	 * @param string $meta_type Type of object metadata is for. Accepts 'post', 'term', 'user',
 ...
 *
 * @param string $meta_key  Metadata key.
 * @param string $meta_type Optional. Type of object metadata is for. Accepts 'post', 'term', 'user', or any
 *                          other object type with an associated meta table. Default empty string.
 ...
 * @param string $object_type    Type of object metadata is for. Accepts 'post', 'term', 'user', or any
 *                               other object type with an associated meta table.
...
function sanitize_meta( $meta_key, $meta_value, $object_type, $object_subtype = '' ) {
	if ( ! empty( $object_subtype ) && has_filter( "sanitize_{$object_type}_meta_{$meta_key}_for_{$object_subtype}" ) ) {
		 ...
		 * @param mixed  $meta_value     Metadata value to sanitize.
		 * @param string $meta_key       Metadata key.
		 * @param string $object_type    Type of object metadata is for. Accepts 'post', 'term', 'user',
		 *                               or any other object type with an associated meta table.
	 ...
	 * refer to the metadata object type (post, term, or user) and the meta
 ...
 *
 * If an object type does not support any subtypes, such as users you should commonly call this function
