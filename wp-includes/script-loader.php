...
function wp_hoist_late_printed_styles() {
	 ...
	 * head. However, with the template enhancement output buffer, essentially no style can be enqueued too late,
	 * because an output buffer filter can always hoist it to the HEAD.
	 */
