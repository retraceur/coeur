 ...
 *
 * @since WP 1.5.0
 * @since WP 6.3.0 Returns an empty string if the author's display name is unknown.
 *
 ...
 *
 * @since WP 2.8.0
 * @since WP 6.9.0 Added the `$post` parameter. Unknown return value is now explicitly null instead of void.
 *
 ...
 *
 * @since WP 2.8.0
 * @since WP 6.9.0 Removed `aim`, `jabber`, and `yim` as valid values for the `$field` parameter.
 *
 * @global WP_User $authordata The current author's data.
 *
