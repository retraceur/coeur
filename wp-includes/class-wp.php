<?php
/**
 * Retraceur environment setup class.
 *
 * @since WP 2.0.0
...
class WP {
	 ...
	 *
	 * @since WP 2.0.0
	 * @since 1.0.0 Retraceur fork removed `comments_per_page` query var.
	 * @var string[]
	 */
	...
	/**
	 * Query variables for setting up the Retraceur Query Loop.
	 *
	 * @since WP 2.0.0
	 * @var array
	 */
	...
	/**
	 * Parses the request to find the correct Retraceur query.
	 *
	 * Sets up the query variables based on the request. There are also many
	 * filters and actions that can be used to further manipulate the result.
	 *
	 * @since WP 2.0.0
	 * @since WP 6.0.0 A return value was added.
	 *
	...
	public function parse_request( $extra_query_vars = '' ) {
		 ...
		 * @param WP           $wp               Current Retraceur environment instance.
	 ...
	 *
	 * @since WP 2.0.0
	 * @since WP 4.4.0 `X-Pingback` header is added conditionally for single posts that allow pings.
	 * @since WP 6.1.0 Runs after posts have been queried.
	 *
	...
	public function build_query_string() {
		...
		if ( has_filter( 'query_string' ) ) {  // Don't bother filtering and parsing if no plugins are hooked in.
			 ...
			 *
			 * @since WP 1.5.0
			 * @deprecated WP 2.1.0 Use {@see 'query_vars'} or {@see 'request'} filters instead.
			 *
	...
	/**
	 * Set up the Retraceur Globals.
	 *
	 * The query_vars property will be extracted to the GLOBALS. So care should
	 * be taken when naming global variables that might interfere with the
	 * Retraceur environment.
	 *
	 * @since WP 2.0.0
	 *
	 * @global WP_Query     $wp_query     Retraceur Query object.
	...
	public function handle_404() {
		 ...
		 * @param WP_Query $wp_query Retraceur Query object.
		 */
	...
	/**
	 * Sets up all of the variables required by the Retraceur environment.
	 *
	...
	public function main( $query_args = '' ) {
		...
		/**
		 * Fires once the Retraceur environment has been set up.
		 *
		 * @since WP 2.1.0
		 *
		 * @param WP $wp Current Retraceur environment instance (passed by reference).
