...
function get_attachment_link( $post = null, $leavename = false ) {
	 ...
	 *
	 * @since WP 2.0.0
	 * @since WP 5.6.0 Providing an empty string will now disable
 ...
 *
 * @since WP 3.1.0
 * @since WP 4.5.0 The `$taxonomy` parameter was made optional.
 *
...
function get_search_feed_link( $search_query = '', $feed = '' ) {
	 ...
	 * @param string $feed Feed type. Possible values include 'rss2', 'atom'.
	 * @param string $type The search type. One of 'posts'.
	 */
 ...
 *
 * @since WP 2.3.0
 * @since WP 6.3.0 Adds custom link for wp_navigation post types.
 ...
 *
 * @since WP 1.0.0
 * @since WP 4.4.0 The `$css_class` argument was added.
 *
...
function get_adjacent_post( $in_same_term = false, $excluded_terms = '', $previous = true, $taxonomy = 'category' ) {
	 ...
	 * @since WP 2.5.0
	 * @since WP 4.4.0 Added the `$taxonomy` and `$post` parameters.
	 * @since WP 6.9.0 Adds ID-based fallback for posts with identical dates in adjacent post queries.
	 *
	 ...
	 * @since WP 6.9.0 Adds ID sort to ensure deterministic ordering for posts with identical dates.
	 *
...
function get_pagenum_link( $pagenum = 1, $escape = true ) {
	 ...
	 *
	 * @since WP 2.5.0
	 * @since WP 5.2.0 Added the `$pagenum` argument.
	 *
...
function get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
	 ...
	 *
	 * @since WP 2.8.0
	 * @since WP 5.8.0 The `$scheme` parameter was added.
	 *
 ...
 *                           user email, WP_User object, or WP_Post object object.
 * @param array $args {
...
function get_avatar_data( $id_or_email, $args = null ) {
	 ...
	 *
	 * @since WP 4.2.0
	 * @since 1.0.0 Retraceur fork added the `$url_args` parameter.
	 *
	 * @param array $args        Arguments passed to get_avatar_data(), after processing.
	 * @param mixed $id_or_email The avatar to retrieve. Accepts a user ID, Gravatar MD5 hash,
	 *                           user email, WP_User object, or WP_Post object.
	 * @param array $url_args    URL query parameters.
	 */
	return apply_filters( 'get_avatar_data', $args, $id_or_email, $url_args );
}
 ...
 *
 * @since WP 4.9.6
 * @since WP 6.2.0 Added 'privacy-policy' rel attribute.
 *
 * @param string $before Optional. Display before privacy policy link. Default empty.
 * @param string $after  Optional. Display after privacy policy link. Default empty.
