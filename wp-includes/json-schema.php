 ...
 * Retraceur's server-side validation, such as by REST clients, frontend code,
 * or AI providers.
 *
 ...
 * schemas.
 *
 * Allowing a keyword to be exposed does not make Retraceur validate or
...
function wp_get_json_schema_allowed_keywords( string $schema_profile = 'rest-api' ): array {
	 ...
	 * It does not make WP validate or sanitize values against the keyword.
	 *
	 * @since WP 7.1.0
	 *
 ...
 *
 * Use this before exposing a schema outside of Retraceur's server-side
 ...
 * can understand.
 *
 * Retraceur-internal schema conveniences are converted or removed only where
