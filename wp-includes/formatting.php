 ...
 * @since WP 1.2.1
 * @deprecated WP 6.9.0 Use {@see wp_is_valid_utf8()} instead.
 *
 ...
 *
 * @since WP 2.8.0
 * @since WP 6.9.0 Stripping replaces invalid byte sequences with the Unicode replacement character U+FFFD (�).
 *
 ...
 * @since WP 5.7.0 Added locale support for `de_AT`.
 * @since WP 6.0.0 Added the `$locale` parameter.
 * @since WP 6.1.0 Added Unicode NFC encoding normalization support.
 * @since WP 7.0.0 Added capital Eszett (U+1E9E) support for German locales.
 *
 ...
 *
 * @since WP 2.0.4
 * @since WP 5.3.0 Improve accuracy and add support for custom element tags.
 *
 ...
 *
 * @since WP 0.71
 * @since WP 7.1.0 Masquerades multibyte characters.
 *
 ...
 *
 * @since WP 2.3.0
 * @deprecated WP 5.3.0 Use wp_rel_callback()
 *
 * @param array $matches Single match.
 ...
 *
 * @since WP 5.1.0
 * @since WP 5.6.0 Removed 'noreferrer' relationship.
 * @deprecated WP 6.7.0
 *
 * @param string $text Content that may contain HTML A elements.
 * @return string Converted content.
 ...
 *
 * @since WP 1.5.0
 * @since WP 5.3.0 Added support for showing a difference in seconds.
 *
 ...
 * @since WP 6.3.0 Removes footnotes markup from the excerpt content.
 *
 ...
 *
 * @since WP 2.5.0
 * @since WP 6.5.5 Allow hyphens in tag names (i.e. custom elements).
 *
...
function _print_emoji_detection_script() {
	$settings = array(
		 ...
		 */
		'baseUrl' => apply_filters( 'emoji_url', 'https://cdn.jsdelivr.net/gh/hfg-gmuend/openmoji/color/72x72/' ),
		 ...
		 */
		'svgUrl'  => apply_filters( 'emoji_svg_url', 'https://cdn.jsdelivr.net/gh/hfg-gmuend/openmoji/color/svg/' ),
...
function wp_staticize_emoji( $text ) {
	...
	/** This filter is documented in wp-includes/formatting.php */
	$cdn_url = apply_filters( 'emoji_url', 'https://cdn.jsdelivr.net/gh/hfg-gmuend/openmoji/color/72x72/' );
	...
	for ( $i = 0; $i < $stop; $i++ ) {
		...
		if ( '' === $ignore_block_element && strlen( $content ) > 0 && '<' !== $content[0] && str_contains( $content, '&#x' ) ) {
			foreach ( $possible_emoji as $emojum => $emoji_char ) {
				...
				$entity = sprintf( '<img src="%s" alt="%s" class="wp-smiley" style="height: 1em; max-height: 1em;" />', $cdn_url . strtoupper( $file ) . $ext, $emoji_char );
