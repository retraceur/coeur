...
class WP_Ability {
	 ...
	 *
	 * @since WP 6.9.0
	 * @since WP 7.1.0 Added the `wp_ability_normalize_input` filter.
	 *
	 ...
	 *
	 * @since WP 6.9.0
	 * @since WP 7.1.0 Added the `wp_ability_permission_result` filter.
	 *
	 * @see validate_input()
	 *
	 ...
	 *
	 * @since WP 6.9.0
	 * @since WP 7.1.0 Added the `wp_ability_execute_result` filter.
	 *
	 * @param mixed $input Optional. The input data for the ability. Default `null`.
	 ...
	 *
	 * @since WP 6.9.0
	 * @since WP 7.1.0 Added the `wp_ability_invoked` action.
	 * @since WP 7.1.0 Added the `wp_pre_execute_ability` filter.
	 *
	 * @param mixed $input Optional. The input data for the ability. Default `null`.
	 * @return mixed|WP_Error The result of the ability execution, or WP_Error on failure.
	 */
	public function execute( $input = null ) {
		 ...
		 *
		 * @since WP 6.9.0
		 * @since WP 7.1.0 Added the `$ability` parameter.
		 *
		 * @param string     $ability_name The name of the ability.
