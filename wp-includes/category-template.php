...
function get_the_category( $post_id = false ) {
	 ...
	 *
	 * @since WP 3.1.0
	 * @since WP 4.4.0 Added the `$post_id` parameter.
	 *
 ...
 *
 * @since WP 1.2.0
 * @since WP 2.7.0 The `$post` parameter was added.
 *
 ...
 * @since WP 6.1.0 Introduced the `aria_describedby` argument.
 *
 ...
 *
 * @since WP 2.1.0
 * @since WP 4.4.0 Introduced the `hide_title_if_empty` and `separator` arguments.
 * @since WP 4.4.0 The `current_category` argument was modified to optionally accept an array of values.
 * @since WP 6.1.0 Default value of the 'use_desc_for_title' argument was changed from 1 to 0.
 *
 * @param array|string $args {
 ...
 *
 * @since WP 2.3.0
 * @since WP 2.8.0 Added the `taxonomy` argument.
 * @since WP 4.8.0 Added the `show_count` argument.
 *
 * @param array|string $args {
 ...
 *
 * @since WP 2.8.0
 * @since WP 4.9.2 The `$taxonomy` parameter was deprecated.
 *
