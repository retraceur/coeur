 ...
 *
 * @since WP 6.4.0
 * @since WP 6.5.0 Added support for `backgroundPosition` and `backgroundRepeat` output.
 * @since WP 6.6.0 Removed requirement for `backgroundImage.source`. A file/url is the default.
 * @since WP 6.7.0 Added support for `backgroundAttachment` output.
 * @since WP 7.1.0 Added support for `background.gradient` output.
 *
 * @access private
 *
