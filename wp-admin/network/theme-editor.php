...
if ( ! has_filter( 'retraceur_network_admin_theme_editor', 'retraceur_reseau_network_admin_theme_editor' ) ) {
	wp_die(
 ...
 */
if ( apply_filters( 'retraceur_network_admin_theme_editor', false ) ) {
