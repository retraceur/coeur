...
if ( ! has_filter( 'retraceur_network_admin_theme_install', 'retraceur_reseau_network_admin_theme_install' ) ) {
	wp_die(
 ...
 */
if ( apply_filters( 'retraceur_network_admin_theme_install', false ) ) {
