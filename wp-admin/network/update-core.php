...
if ( ! has_filter( 'retraceur_network_admin_update_core', 'retraceur_reseau_network_admin_update_core' ) ) {
	wp_die(
 ...
 */
if ( apply_filters( 'retraceur_network_admin_update_core', false ) ) {
