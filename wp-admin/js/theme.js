...
themes.Collection = Backbone.Collection.extend({
	...
	// Send request to distant Themes API.
...
themes.view.InstallerSearch =  themes.view.Search.extend({
	...
	doSearch: function( value ) {
		...
		// Get the themes by sending Ajax POST request distant Themes API.
...
themes.view.Installer = themes.view.Appearance.extend({
	...
	browse: function( section ) {
		...
		if ( 'block-themes' === section ) {
			// Get the themes by sending Ajax POST request to distant Themes API
			// or searching the local cache.
	...
	// Save the user's username and get his favorite themes.
