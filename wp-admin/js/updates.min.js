...
_x("Updating %s...","plugin"),d.data("name")),l.removeClass("plugin-card-update-failed").find(".notice.notice-error").remove()),r.addClass("spin"),d.html()!==__("Updating...")&&d.data("originaltext",d.html()),d.attr("aria-label",u).text(o),s.trigger("wp-plugin-updating",a),p&&"plugin-information-footer"===l.attr("id")&&t.updates.setCardButtonStatus({status:"updating-plugin",slug:a.slug,addClasses:"updating-message",text:o,ariaLabel:u}),t.updates.ajax("update-plugin",a)},t.updates.updatePluginSuccess=function(a){var i,l,d,u=e("#wp-admin-bar-updates"),r=_x("Updated!","plugin"),o=n(/* translators: %s: Plugin name and version. */
_x("%s updated!","plugin"),a.pluginName);"plugins"===pagenow||"plugins-network"===pagenow?(l=(i=e('tr[data-plugin="'+a.plugin+'"]').removeClass("update is-enqueued").addClass("updated")).find(".update-message").removeClass("updating-message notice-warning").addClass("updated-message notice-success").find("p"),d=i.find(".plugin-version-author-uri").html().replace(a.oldVersion,a.newVersion),i.find(".plugin-version-author-uri").html(d),i.find(".auto-update-time").empty()):"plugin-install"!==pagenow&&"plugin-install-network"!==pagenow||(l=e(".plugin-card-"+a.slug+", #plugin-information-footer").find(".update-now").removeClass("updating-message").addClass("button-disabled updated-message")),u.removeClass("spin"),l.attr("aria-label",o).text(r),t.a11y.speak(__("Update completed successfully.")),"plugin_install_from_iframe"!==l.attr("id")?t.updates.decrementCount("plugin"):t.updates.setCardButtonStatus({status:"updated-plugin",slug:a.slug,removeClasses:"updating-message",addClasses:"button-disabled updated-message",text:r,ariaLabel:o}),s.trigger("wp-plugin-update-success",a)},t.updates.updatePluginError=function(a){var i,l,d,u,r,o=e("#wp-admin-bar-updates");t.updates.isValidResponse(a,"update")&&(t.updates.maybeHandleCredentialError(a,"update-plugin")||(d=n(/* translators: %s: Error string for a failed update. */
...
_x("%s update failed.","plugin"),a.pluginName)):l.find("p").removeAttr("aria-label")):"plugin-install"!==pagenow&&"plugin-install-network"!==pagenow||(u=__("Update failed."),(i=e(".plugin-card-"+a.slug+", #plugin-information-footer").append(t.updates.adminNotice({className:"update-message notice-error notice-alt is-dismissible",message:d}))).hasClass("plugin-card-"+a.slug)&&i.addClass("plugin-card-update-failed"),i.find(".update-now").text(u).removeClass("updating-message"),a.pluginName?(r=n(/* translators: %s: Plugin name and version. */
_x("%s update failed.","plugin"),a.pluginName),i.find(".update-now").attr("aria-label",r)):(r="",i.find(".update-now").removeAttr("aria-label")),i.on("click",".notice.is-dismissible .notice-dismiss",(function(){setTimeout((function(){i.removeClass("plugin-card-update-failed").find(".column-name a").trigger("focus"),i.find(".update-now").attr("aria-label",!1).text(__("Update Now"))}),200)}))),o.removeClass("spin"),t.a11y.speak(d,"assertive"),"plugin-information-footer"===i.attr("id")&&t.updates.setCardButtonStatus({status:"plugin-update-failed",slug:a.slug,removeClasses:"updating-message",text:u,ariaLabel:r}),s.trigger("wp-plugin-update-error",a)))},t.updates.installPlugin=function(a){var i,l=e(".plugin-card-"+a.slug+", #plugin-information-footer"),d=l.find(".install-now"),u=__("Installing...");return a=_.extend({success:t.updates.installPluginSuccess,error:t.updates.installPluginError},a),"import"===pagenow&&(d=e('[data-slug="'+a.slug+'"]')),d.html()!==__("Installing...")&&d.data("originaltext",d.html()),i=n(/* translators: %s: Plugin name and version. */
...
__("Installation failed: %s"),a.errorMessage),l.addClass("plugin-card-update-failed").append('<div class="notice notice-error notice-alt is-dismissible" role="alert"><p>'+i+"</p></div>"),l.on("click",".notice.is-dismissible .notice-dismiss",(function(){setTimeout((function(){l.removeClass("plugin-card-update-failed").find(".column-name a").trigger("focus")}),200)})),d.removeClass("updating-message").addClass("button-disabled").attr("aria-label",r).text(u),t.a11y.speak(i,"assertive"),t.updates.setCardButtonStatus({status:"plugin-install-failed",slug:a.slug,removeClasses:"updating-message",addClasses:"button-disabled",text:u,ariaLabel:r}),s.trigger("wp-plugin-install-error",a)))},t.updates.checkPluginDependencies=function(e){return e=_.extend({success:t.updates.checkPluginDependenciesSuccess,error:t.updates.checkPluginDependenciesError},e),t.a11y.speak(__("Checking plugin dependencies... please wait.")),s.trigger("wp-checking-plugin-dependencies",e),t.updates.ajax("check_plugin_dependencies",e)},t.updates.checkPluginDependenciesSuccess=function(a){var i,l,d=e(".plugin-card-"+a.slug+", #plugin-information-footer").find(".install-now");d.removeClass("install-now installed button-disabled updated-message").addClass("activate-now button-primary").attr("href",a.activateUrl),t.a11y.speak(__("Plugin dependencies check completed successfully.")),s.trigger("wp-check-plugin-dependencies-success",a),"plugins-network"===pagenow?(i=_x("Network Activate","plugin"),l=n(/* translators: %s: Plugin name. */
...
_x("Install %s now","plugin"),l)).text(_x("Install Now","plugin")),t.a11y.speak(__("Update canceled."))}))),t.updates.installPlugin({slug:i.data("slug"),pagenow,success:t.updates.installImporterSuccess,error:t.updates.installImporterError}))})),l.on("click","[data-plugin] a.delete",(function(a){var s,i=e(a.target).parents("tr");s=i.hasClass("is-uninstallable")?n(/* translators: %s: Plugin/Theme name. */
__("Are you sure you want to delete %s and its data?"),i.find(".plugin-title strong").text()):n(/* translators: %s: Plugin/Theme name. */
__("Are you sure you want to delete %s?"),i.find(".plugin-title strong").text()),a.preventDefault(),window.confirm(s)&&(t.updates.maybeRequestFilesystemCredentials(a),t.updates.deletePlugin({plugin:i.data("plugin"),slug:i.data("slug")}))})),s.on("click",".themes-php.network-admin .update-link",(function(a){var s=e(a.target),n=s.parents("tr");a.preventDefault(),s.hasClass("updating-message")||s.hasClass("button-disabled")||(t.updates.maybeRequestFilesystemCredentials(a),t.updates.$elToReturnFocusToFromCredentialsModal=n.find(".check-column input"),t.updates.updateTheme({slug:n.data("slug")}))})),s.on("click",".themes-php.network-admin a.delete",(function(a){var s=e(a.target).parents("tr"),i=n(/* translators: %s: Plugin/Theme name. */
__("Are you sure you want to delete %s?"),s.find(".theme-title strong").text());a.preventDefault(),window.confirm(i)&&(t.updates.maybeRequestFilesystemCredentials(a),t.updates.deleteTheme({slug:s.data("slug")}))})),l.on("click",'[type="submit"]:not([name="clear-recent-list"])',(function(a){var i,d,u=e(a.target).siblings("select").val(),r=l.find('input[name="checked[]"]:checked'),o=0,p=0,c=[];switch(pagenow){case"plugins":case"plugins-network":i="plugin";break;case"themes-network":i="theme";break;default:return}switch(r.length||(u=!1),u){case"update-selected":d=u.replace("selected",i);break;case"delete-selected":var g=__("plugin"===i?"Are you sure you want to delete the selected plugins and their data?":"Caution: These themes may be active on other sites in the network. Are you sure you want to proceed?");if(!window.confirm(g))return void a.preventDefault();d=u.replace("selected",i);break;default:return}t.updates.maybeRequestFilesystemCredentials(a),a.preventDefault(),l.find('.manage-column [type="checkbox"]').prop("checked",!1),s.trigger("wp-"+i+"-bulk-"+u,r),r.each((function(a,s){var n=e(s),i=n.parents("tr");"update-selected"!==u||i.hasClass("update")&&!i.find("notice-error").length?"update-selected"===u&&i.hasClass("is-enqueued")||(i.addClass("is-enqueued"),t.updates.queue.push({action:d,data:{plugin:i.data("plugin"),slug:i.data("slug")}})):n.prop("checked",!1)})),s.on("wp-plugin-update-success wp-plugin-update-error wp-theme-update-success wp-theme-update-error",(function(a,s){var i,l,d=e('[data-slug="'+s.slug+'"]');"wp-"+s.update+"-update-success"===a.type?o++:(l=s.pluginName?s.pluginName:d.find(".column-primary strong").text(),p++,c.push(l+": "+s.errorMessage)),d.find('input[name="checked[]"]:checked').prop("checked",!1),t.updates.adminNotice=t.template("wp-bulk-updates-admin-notice");var u=null;o&&(u="plugin"===s.update?n(/* translators: %s: Number of plugins. */
_n("%s plugin successfully updated.","%s plugins successfully updated.",o),o):n(/* translators: %s: Number of themes. */
_n("%s theme successfully updated.","%s themes successfully updated.",o),o));var r=null;p&&(r=n(/* translators: %s: Number of failed updates. */
_n("%s update failed.","%s updates failed.",p),p)),t.updates.addAdminNotice({id:"bulk-action-notice",className:"bulk-action-notice",successMessage:u,errorMessage:r,errorMessages:c,type:s.update}),i=e("#bulk-action-notice").on("click","button",(function(){e(this).toggleClass("bulk-action-errors-collapsed").attr("aria-expanded",!e(this).hasClass("bulk-action-errors-collapsed")),i.find(".bulk-action-errors").toggleClass("hidden")})),p>0&&!t.updates.queue.length&&e("html, body").animate({scrollTop:0})})),s.on("wp-updates-notice-added",(function(){t.updates.adminNotice=t.template("wp-updates-admin-notice")})),t.updates.queueChecker()})),o.length&&o.attr("aria-describedby","live-search-desc");var p=0;t.updates.shouldSearch=function(e){var a=e>=t.updates.searchMinCharacters||p>t.updates.searchMinCharacters;return p=e,a},o.on("keyup input",_.debounce((function(a,s){var l,d,u=e(".plugin-install-search"),r=o.val().length;l={_ajax_nonce:t.updates.ajaxNonce,s:encodeURIComponent(a.target.value),tab:"search",type:e("#typeselector").val(),pagenow},d=location.href.split("?")[0]+"?"+e.param(_.omit(l,["_ajax_nonce","pagenow"])),t.updates.shouldSearch(r)?(o.attr("autocomplete","off"),"keyup"===a.type&&27===a.which&&(a.target.value=""),t.updates.searchTerm===l.s&&"typechange"!==s||(i.empty(),t.updates.searchTerm=l.s,window.history&&window.history.replaceState&&window.history.replaceState(null,"",d),u.length||(u=e('<li class="plugin-install-search" />').append(e("<a />",{class:"current",href:d,text:__("Search Results")})),e(".wp-filter .filter-links .current").removeClass("current").parents(".filter-links").prepend(u),i.prev("p").remove(),e(".plugins-popular-tags-wrapper").remove()),void 0!==t.updates.searchRequest&&t.updates.searchRequest.abort(),e("body").addClass("loading-content"),t.updates.searchRequest=t.ajax.post("search-install-plugins",l).done((function(a){e("body").removeClass("loading-content"),i.append(a.items),delete t.updates.searchRequest,0===a.count?t.a11y.speak(__("You do not appear to have any plugins available at this time.")):t.a11y.speak(n(/* translators: %s: Number of plugins. */
__("Number of plugins found: %d"),a.count))})))):o.attr("autocomplete","on")}),1e3)),r.length&&r.attr("aria-describedby","live-search-desc"),r.on("keyup input",_.debounce((function(a){var s,i={_ajax_nonce:t.updates.ajaxNonce,s:encodeURIComponent(a.target.value),pagenow,plugin_status:"all"},d=r.val().length;t.updates.shouldSearch(d)?(r.attr("autocomplete","off"),"keyup"===a.type&&27===a.which&&(a.target.value=""),t.updates.searchTerm!==i.s&&(t.updates.searchTerm=i.s,s=_.object(_.compact(_.map(location.search.slice(1).split("&"),(function(e){if(e)return e.split("=")})))),i.plugin_status=s.plugin_status||"all",window.history&&window.history.replaceState&&window.history.replaceState(null,"",location.href.split("?")[0]+"?s="+i.s+"&plugin_status="+i.plugin_status),void 0!==t.updates.searchRequest&&t.updates.searchRequest.abort(),l.empty(),e("body").addClass("loading-content"),e(".subsubsub .current").removeClass("current"),t.updates.searchRequest=t.ajax.post("search-plugins",i).done((function(a){var s=e("<span />").addClass("subtitle").html(n(/* translators: %s: Search query. */
...
__("Number of plugins found: %d"),a.count))})))):r.attr("autocomplete","on")}),500)),s.on("submit",".search-plugins",(function(t){t.preventDefault(),e("input.wp-filter-search").trigger("input")})),s.on("click",".try-again",(function(e){e.preventDefault(),o.trigger("input")})),e("#typeselector").on("change",(function(){var t=e('input[name="s"]');t.val().length&&t.trigger("input","typechange")})),e("#plugin_update_from_iframe").on("click",(function(t){var a,s=window.parent===window?null:window.parent;e.support.postMessage=!!window.postMessage,!1!==e.support.postMessage&&null!==s&&-1===window.parent.location.pathname.indexOf("update-core.php")&&(t.preventDefault(),a={action:"update-plugin",data:{plugin:e(this).data("plugin"),slug:e(this).data("slug")}},s.postMessage(JSON.stringify(a),window.location.origin))})),e(window).on("message",(function(a){var s,n=a.originalEvent,i=document.location.protocol+"//"+document.location.host;if(n.origin===i){try{s=JSON.parse(n.data)}catch(e){return}if(s){if(void 0!==s.status&&void 0!==s.slug&&void 0!==s.text&&void 0!==s.ariaLabel){var l=e(".plugin-card-"+s.slug).find('[data-slug="'+s.slug+'"]');void 0!==s.removeClasses&&l.removeClass(s.removeClasses),void 0!==s.addClasses&&l.addClass(s.addClasses),""===s.ariaLabel?l.removeAttr("aria-label"):l.attr("aria-label",s.ariaLabel),"dependencies-check-success"===s.status&&l.attr("data-name",s.pluginName).attr("data-slug",s.slug).attr("data-plugin",s.plugin).attr("href",s.href),l.text(s.text)}if(void 0!==s.action)switch(s.action){case"decrementUpdateCount":t.updates.decrementCount(s.upgradeType);break;case"install-plugin":case"update-plugin":if(void 0===s.data||void 0===s.data.slug)return;s.data=t.updates._addCallbacks(s.data,s.action),t.updates.queue.push(s),t.updates.queueChecker()}}}})),e(window).on("beforeunload",t.updates.beforeunload),s.on("keydown",".column-auto-updates .toggle-auto-update, .theme-overlay .toggle-auto-update",(function(e){32===e.which&&e.preventDefault()})),s.on("click keyup",".column-auto-updates .toggle-auto-update, .theme-overlay .toggle-auto-update",(function(n){var i,l,d,u,r=e(this),o=r.attr("data-wp-action"),p=r.find(".label");if(("keyup"!==n.type||32===n.which)&&(u="themes"!==pagenow?r.closest(".column-auto-updates"):r.closest(".theme-autoupdate"),n.preventDefault(),"yes"!==r.attr("data-doing-ajax"))){switch(r.attr("data-doing-ajax","yes"),pagenow){case"plugins":case"plugins-network":d="plugin",l=r.closest("tr").attr("data-plugin");break;case"themes-network":d="theme",l=r.closest("tr").attr("data-slug");break;case"themes":d="theme",l=r.attr("data-slug")}u.find(".notice.notice-error").addClass("hidden"),"enable"===o?p.text(__("Enabling...")):p.text(__("Disabling...")),r.find(".dashicons-update").removeClass("hidden"),i={action:"toggle-auto-updates",_ajax_nonce:a.ajax_nonce,state:o,type:d,asset:l},e.post(window.ajaxurl,i).done((function(a){var n,i,c,g,m,f=r.attr("href");if(!a.success)return m=a.data&&a.data.error?a.data.error:__("The request could not be completed."),u.find(".notice.notice-error").removeClass("hidden").find("p").text(m),void t.a11y.speak(m,"assertive");if("themes"!==pagenow){switch(n=e(".auto-update-enabled span"),i=e(".auto-update-disabled span"),c=parseInt(n.text().replace(/[^\d]+/g,""),10)||0,g=parseInt(i.text().replace(/[^\d]+/g,""),10)||0,o){case"enable":++c,--g;break;case"disable":--c,++g}c=Math.max(0,c),g=Math.max(0,g),n.text("("+c+")"),i.text("("+g+")")}"enable"===o?(r[0].hasAttribute("href")&&(f=f.replace("action=enable-auto-update","action=disable-auto-update"),r.attr("href",f)),r.attr("data-wp-action","disable"),p.text(__("Disable auto-updates")),u.find(".auto-update-time").removeClass("hidden"),t.a11y.speak(__("Auto-updates enabled"))):(r[0].hasAttribute("href")&&(f=f.replace("action=disable-auto-update","action=enable-auto-update"),r.attr("href",f)),r.attr("data-wp-action","enable"),p.text(__("Enable auto-updates")),u.find(".auto-update-time").addClass("hidden"),t.a11y.speak(__("Auto-updates disabled"))),s.trigger("wp-auto-update-setting-changed",{state:o,type:d,asset:l})})).fail((function(){u.find(".notice.notice-error").removeClass("hidden").find("p").text(__("The request could not be completed.")),t.a11y.speak(__("The request could not be completed."),"assertive")})).always((function(){r.removeAttr("data-doing-ajax").find(".dashicons-update").addClass("hidden")}))}}))}))})();