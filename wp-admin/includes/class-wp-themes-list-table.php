		...
		if ( is_multisite() ) {
			...
			if ( current_user_can( 'install_themes' ) ) {
				printf(
					...
					__( 'You only have one theme installed right now. You can add new ones clicking on the Upload Theme button at any time: just click on the <a href="%s">Install Themes</a> link.' ),
