<?php
/**
 * motsVertueux Export Administration API.
 *
...
function export_wp( $args = array() ) {
	...
	function wxr_site_url() {
		if ( is_multisite() ) {
			...
			// motsVertueux (single site): the site URL.
	...
	?>
<!-- This is a motsVertueux eXtended RSS file generated by motsVertueux as an export of your site. -->
<!-- It contains information about your site's posts, pages, comments, categories, and other content. -->
<!-- You may use this file to transfer that content from one site to another. -->
<!-- This file is not intended to serve as a complete backup of your site. -->

<!-- To import this information into a motsVertueux site follow these steps: -->
<!-- 1. Log in to that site as an administrator. -->
<!-- 2. Go to Tools: Import in the motsVertueux admin panel. -->
...
<!-- 7. motsVertueux will then import each of the posts, pages, comments, categories, etc. -->
