<?php
/**
 * Retraceur Export Administration API.
 *
...
function export_wp( $args = array() ) {
	...
	function wxr_site_url() {
		if ( is_multisite() ) {
			...
			// Retraceur (single site): the site URL.
	...
	?>
<!-- This is a Retraceur eXtended RSS file generated by Retraceur as an export of your site. -->
<!-- It contains information about your site's posts, pages, categories, and other content. -->
...
<!-- 7. Retraceur will then import each of the posts, pages, categories, etc. -->
