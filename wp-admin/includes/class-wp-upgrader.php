...
class WP_Upgrader {
	...
	/**
	 * Downloads a package for a Retraceur core, plugin, theme, or translation upgrade.
	 *
	 * @since WP 2.8.0
	...
	public function download_package( $package, $check_signatures = false, $hook_extra = array() ) {
		/**
		 * Filters whether to download a package for a Retraceur core, plugin, theme, or translation upgrade.
		 *
	...
	/**
	 * Creates a lock using Retraceur options.
	 *
	 * @since WP 4.5.0
	 *
