 ...
 *
 * @since WP 3.2.0
 * @since WP 7.0.0 Applied when `wp-admin/options.php` is accessed directly.
 *
...
if ( ! is_multisite() ) {
	...
	$allowed_options['membership'][] = 'users_can_register';
	$allowed_options['membership'][] = 'default_role';
