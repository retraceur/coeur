 ...
 * base prefix, Retraceur core can no longer account for the possible collision.
 */
...
<?php if ( ! is_multisite() ) : ?>
	...
	if ( $iis7_permalinks ) :
		if ( isset( $_POST['submit'] ) && $permalink_structure && ! $using_index_permalinks && ! $writable ) :
			if ( file_exists( $home_path . 'web.config' ) ) :
				...
				<?php
				printf(
					/* translators: 1: web.config, 2: Ctrl + A, 3: ⌘ + A, 5: Element code. */
					__( '<strong>Error:</strong> Your %1$s file is not writable, so updating it automatically was not possible. This is the URL rewrite rule you should have in your %1$s file. Click in the field and press %2$s (or %3$s on Mac) to select all. Then insert this rule inside of the %4$s element in %1$s file.' ),
					'<code>web.config</code>',
					'<kbd>Ctrl + A</kbd>',
					'<kbd>⌘ + A</kbd>',
			...
			<?php else : ?>
				...
				<?php
				printf(
					/* translators: 1: web.config, 2: Ctrl + A, 3: ⌘ + A */
					__( '<strong>Error:</strong> The root directory of your site is not writable, so creating a file automatically was not possible. This is the URL rewrite rule you should have in your %1$s file. Create a new file called %1$s in the root directory of your site. Click in the field and press %2$s (or %3$s on Mac) to select all. Then insert this code into the %1$s file.' ),
					'<code>web.config</code>',
					'<kbd>Ctrl + A</kbd>',
					'<kbd>⌘ + A</kbd>'
				);
	...
	<?php else : ?>
		<?php if ( $permalink_structure && ! $using_index_permalinks && ! $writable && $htaccess_update_required ) : ?>
			...
			<?php
			printf(
				/* translators: 1: .htaccess, 2: Ctrl + A, 3: ⌘ + A */
				__( '<strong>Error:</strong> Your %1$s file is not writable, so updating it automatically was not possible. These are the mod_rewrite rules you should have in your %1$s file. Click in the field and press %2$s (or %3$s on Mac) to select all.' ),
				'<code>.htaccess</code>',
				'<kbd>Ctrl + A</kbd>',
				'<kbd>⌘ + A</kbd>'
			);
