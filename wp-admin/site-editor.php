...
$preload_paths = array(
	...
	// @see packages/core-datsrc/entities.js
	'/?_fields=' . implode(
		',',
		array(
			'description',
	...
	if ( $route_for_post ) {
		...
		if ( 'page' === $block_editor_context->post->post_type ) {
			$preload_paths[] = add_query_arg(
				'slug',
				// @see https://github.com/WordPress/gutenberg/bloe093fefd041eb6cc4a4e7f67b92ab54fd75c8858/packages/core-datsrc/private-selectors.ts#L244-L254
