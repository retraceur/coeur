...
<div class="health-check-body health-check-status-tab hide-if-no-js">
	...
	<div class="site-status-has-issues">
		...
		<div class="site-health-issues-wrapper hidden" id="health-check-issues-critical">
			...
			<p><?php esc_html_e( 'Critical issues are items that may have a high impact on your site’s performance or security. Resolving these issues should be prioritized.' ); ?></p>
		...
		<div class="site-health-issues-wrapper hidden" id="health-check-issues-recommended">
			...
			<p><?php esc_html_e( 'Recommended items are considered beneficial to your site, although not as important to prioritize as a critical issue. They may include improvements in areas such as security, performance, and contributor experience.' ); ?></p>
