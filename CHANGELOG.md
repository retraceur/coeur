...
- Backports WP 7.0.5 Security fixes: No functional changes have been introduced in Retraceur itself. This maintenance release focuses exclusively on keeping the project aligned with the latest upstream security updates while preserving its own direction. Props to the WP security team and all contributors involved in identifying, reporting, and fixing these vulnerabilities. **Upgrade is strongly recommended**.
...
- Backports WP 7.0.4 Security fixes: No functional changes have been introduced in Retraceur itself. This maintenance release focuses exclusively on keeping the project aligned with the latest upstream security updates while preserving its own direction. Props to the WP security team and all contributors involved in identifying, reporting, and fixing these vulnerabilities. **Upgrade is strongly recommended**.
...
- Backports WP 7.0.3 Security fixes: No functional changes have been introduced in Retraceur itself. This maintenance release focuses exclusively on keeping the project aligned with the latest upstream security updates while preserving its own direction. Props to the WP security team and all contributors involved in identifying, reporting, and fixing these vulnerabilities. **Upgrade is strongly recommended**.
