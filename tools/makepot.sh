...
wp i18n make-pot . i18n/js/admin-comment.pot --include="wp-admin/js/comment.js" --ignore-domain
...
wp i18n make-pot . i18n/js/admin-edit-comments.pot --include="wp-admin/js/edit-comments.js" --ignore-domain
